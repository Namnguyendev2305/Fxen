...
class SeriesList extends AbstractPlugin
{
	...
	public function applySeriesFilters(\XenAddons\AMS\Finder\SeriesItem $seriesFinder, array $filters)
	{
		...
		if (!empty($filters['has_articles']))
		{
			$seriesFinder->where('article_count', '>', 0);
		}
	...
	public function actionFilters()
	{
		...
		return $this->view('XenAddons\AMS\Series:Filters', 'xa_ams_series_list_filters', $viewParams);
	}
	...
	public function actionFeatured()
	{
		...
		return $this->view('XenAddons\AMS\Series:Featured', 'xa_ams_series_list_featured', $viewParams);
	}
