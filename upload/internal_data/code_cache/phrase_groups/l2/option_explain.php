...
Use the textbox above to specify a format. <b>{title}</b> will be replaced with the fetched page title and <b>{url}</b> will be replaced with the original URL. If no format is entered, the title itself will be displayed.',
  ...
  'option_explain.xaAmsARSWordsPerMinute' => 'Article read time is based on the average reading speed of an adult (roughly 265 words per minute).',
  'option_explain.xaAmsAllowedFileExtensions' => 'List the file extensions that are allowed to be uploaded to articles. Use spaces or line break between extensions.',
  'option_explain.xaAmsArticleAttachmentMaxFileSize' => 'Provide the maximum article attachment file size in kilobytes (KB). Attachments over this size will be rejected.
<br><br>
<b>Important Note:</b> The option "Maximum attachments per article" has been removed and is now set via AMS Permissions!',
  'option_explain.xaAmsArticleDeleteThreadAction' => 'When an article is deleted, take this action with any automatically created thread associated with the article.',
  'option_explain.xaAmsArticleListLayoutType' => 'Choose the layout type you want to use to display articles on ams index, category pages and other various pages with article listings. <b>Note</b>: Individual category pages can override this setting and use a different layout type. 
<br><br>
<b><span style="color:red;">Important Note</span></b>: If the viewing user does not have permission to view ams article attachments, the listing page will be rendered in List View layout type regardless of this option setting (applies to category options and widget options as well).',
  'option_explain.xaAmsArticleMaxLength' => 'The maximum number of characters that can be in an article. This includes BB code. <b>Note</b>: Use 0 to disable the limit.',
  'option_explain.xaAmsArticlesPerPage' => 'The number of articles that will be listed per page on various pages with article listings that use the list view layout type.',
  'option_explain.xaAmsArticlesPerPageAV' => 'The number of articles that will be listed per page on various pages with article listings that use the article view layout type.',
  'option_explain.xaAmsArticlesPerPageGV' => 'The number of articles that will be listed per page on various pages with article listings that use the grid view layout type.',
  'option_explain.xaAmsArticlesPerPageTV' => 'The number of articles that will be listed per page on various pages with article listings that use the tile view layout type.',
  'option_explain.xaAmsArticlesSearchFormTabOrder' => 'Allows you to set the display order of the [Search articles] tab.',
  'option_explain.xaAmsAuthorOtherArticlesCount' => 'The maximum number of articles to display in the "More from [author name]" block. Use 0 to disable this block.',
  'option_explain.xaAmsAuthorPageArticleListLayoutType' => 'Choose the layout type you want to use to display articles on ams author pages (includes the Articles Tab on member profiles) with article listings.
<br><br>
<b><span style="color:red;">Important Note</span></b>: If the viewing user does not have permission to view ams article attachments, the listing page will be rendered in List View layout type regardless of this option setting (applies to article listings throughout AMS to include Widgets).',
  'option_explain.xaAmsAutoFeatureArticles' => 'When enabled, articles will be automatically featured based on selected categories and criteria.',
  'option_explain.xaAmsAutoFeatureCategories' => 'Select the categories from which articles will be featured automatically.',
  'option_explain.xaAmsAutoFeatureComments' => 'Articles that have at least X comments.
<br>
<b>use -1 to ignore</b>',
  'option_explain.xaAmsAutoFeatureExclusive' => 'If enabled, the criteria above will be exclusive (OR), rather than inclusive (AND). 
<br>
...
<b>Inclusive</b>: 300 views AND a reaction score of 50 AND an average rating of 4 AND 25 comments',
  'option_explain.xaAmsAutoFeaturePublished' => 'Articles that have been published within the last x days',
  'option_explain.xaAmsAutoFeatureRating' => 'Articles that have a rating average of at least X.  
<br>
<b>use -1 to ignore</b>',
  'option_explain.xaAmsAutoFeatureReactionScore' => 'Articles that have a reaction score of at least X.  
<br>
<b>use -1 to ignore</b>',
  'option_explain.xaAmsAutoFeatureUpdated' => 'Articles that have been updated within the last x days',
  'option_explain.xaAmsAutoFeatureUserGroups' => 'Select the user groups from which authors articles will be featured automatically
<br><br>
<b>Note:</b> Select (none) to disable this criteria.  If (none) is selected, even with other user groups selected, the system will consider this criteria disabled!',
  'option_explain.xaAmsAutoFeatureViews' => 'Articles that have at least X views.
<br>
<b>use -1 to ignore</b>',
  'option_explain.xaAmsAutoUnfeatureArticles' => 'If enabled, will automatically unfeature any featured articles that are older than x days (from the date the article was featured).',
  'option_explain.xaAmsCategoryOtherArticlesCount' => 'The maximum number of articles to display in the "More in [category name]" block. Use 0 to disable this block.',
  'option_explain.xaAmsCommentAllowedFileExtensions' => 'List the file extensions that are allowed to be uploaded to comments. Use spaces or line break between extensions.',
  'option_explain.xaAmsCommentAttachmentMaxFileSize' => 'Provide the maximum comment attachment file size in kilobytes (KB). Attachments over this size will be rejected.',
  'option_explain.xaAmsCommentMaxLength' => 'The maximum number of characters that can be in an article comment. This includes BB code. Use 0 to disable the limit.',
  'option_explain.xaAmsCommentsPerPage' => '',
  'option_explain.xaAmsDefaultFeaturedMapMarkerIconUrl' => '',
  'option_explain.xaAmsDefaultMapMarkerIconUrl' => '',
  'option_explain.xaAmsDisplayShareBelowArticle' => 'When enabled, will display share icons below the article.',
  'option_explain.xaAmsDisplayUserProfileAboutMe' => 'If the "About article author" is empty, this will attempt to use the "About me" data from the members profile for the "About author" block.',
  'option_explain.xaAmsEnableArticlesAuthorName' => 'When enabled, members will be able to set an author name (like their real name) in the account details, which will replace their username on any of their articles.',
  'option_explain.xaAmsEnableAuthorList' => 'If enabled, members will be able to browse an alphabetical list of authors. This can have performance implications with a large number of authors.',
  'option_explain.xaAmsExcludeFeaturedArticlesFromListing' => 'When enabled, will remove duplicate articles from the AMS Index and Category pages that are already being fetched for the featured articles carousel or grid block.',
  'option_explain.xaAmsExcludeFeaturedSeriesFromListing' => 'When enabled, will remove duplicate series from the Series Index page that are already being fetched for the featured series carousel.',
  'option_explain.xaAmsExpandCategoryNav' => 'When enabled, the Category navigation block will expand the entire category tree.
<br><br>
<b>Note:</b> If you wish to control expanding category navigation on a per category level, <b>do not set this option</b> as this option overrides the per category option.  Instead, use the per category option instead!',
  'option_explain.xaAmsFeaturedArticlesDisplayType' => 'Choose the display type you want to use to display featured articles on ams index, category pages and other various pages with article listings.',
  'option_explain.xaAmsFeaturedArticlesLimit' => 'The number of featured articles you want to fetch for display in the featured articles carousel on AMS index and AMS category pages.  Use 0 to disable the featured articles carousel or grid block.  <b>Note:</b> The featured grid block is limited to displaying 3 articles.',
  'option_explain.xaAmsFeaturedSeriesLimit' => 'The number of featured series you want to fetch for display in the featured series carousel on AMS Series index page.  Use 0 to disable the featured series carousel.',
  'option_explain.xaAmsFilesLocation' => 'Controls where the collection of uploaded file attachments will be displayed',
  'option_explain.xaAmsGalleryDisplayType' => 'Controls the display type (single block or multiple blocks) of the image gallery when set to "Own tab".',
  'option_explain.xaAmsGalleryLocation' => 'Controls where the collection of uploaded images will be displayed',
  'option_explain.xaAmsGoogleMapsEmbedApiKey' => 'Input your Google Maps Embed API Key here. Instructions on generating and retrieving your Google Maps Embed API key can be found <a href="https://developers.google.com/maps/documentation/embed/guide#api_key">here</a>.',
  'option_explain.xaAmsGoogleMapsGeocodingApiKey' => 'Input your Google Maps Geocoding API Key here. Instructions on generating and retrieving your Google Maps Geocoding API key can be found <a href="https://developers.google.com/maps/documentation/geocoding/get-api-key">here</a>.',
  'option_explain.xaAmsGoogleMapsJavaScriptApiKey' => 'Input your Google Maps JavaScript API Key here. Instructions on generating and retrieving your Google Maps JavaScript API key can be found <a href="https://developers.google.com/maps/documentation/javascript/get-api-key">here</a>.',
  'option_explain.xaAmsIncludeCommentsImagesInGallery' => 'This option allows you to include comments image attachments from the comments section in the ams image gallery.  This option is only available when the \'Image gallery location\' option is set to "Own tab".',
  'option_explain.xaAmsIncludePagesImages' => 'This option allows you to include article page image attachments in the image gallery.  This option is only available when the \'Image gallery location\' option is set to "Own tab".',
  'option_explain.xaAmsIncludePostsImagesInGallery' => 'This option allows you to include posts image attachments from the associated discussion thread, in the  ams image gallery.  This option is only available when the \'Image gallery location\' option is set to "Own tab".',
  'option_explain.xaAmsIncludeReviewsImages' => 'This option allows you to include reviews image attachments in the image gallery. This option is only available when the \'Image gallery location\' option is set to "Own tab".',
  'option_explain.xaAmsIndexPageType' => 'Choose the type of Home Page that you want to use for AMS.  
<br>
<ul>
<li>Standard = Index of all articles in a filterable listing.</li>
<li>Modular = Blank page with Main, Sidenav and Sidebar Widget Locations</li>
</ul>',
  'option_explain.xaAmsLatestReviewsCutOffDays' => 'This is the number of days old that a review can be in order for it to be fetched.  Reviews that are older than the cutoff date will not be displayed.  Leave this option set to 0 to bypass the cut off date.',
  'option_explain.xaAmsLimitedViewArticleLength' => 'Users that do not have the permission to view full articles will only see this number of characters of the article.  <b>Note:</b> This setting also applies to Article view layout.',
  'option_explain.xaAmsListDefaultOrder' => 'When viewing various pages with article listings, this will be the default sort order that is set.',
  'option_explain.xaAmsLocalizeGoogleMaps' => 'When enabled, will localize various google maps (both Embed API generated and JS API generated) throughout AMS, based on XF language settings for the viewing user.',
  'option_explain.xaAmsLocationDisplayType' => 'Controls how the location data will be displayed when viewing an article',
  'option_explain.xaAmsMarkerClustering' => 'When enabled, the MarkerClustererPlus library used in combination with the Maps JavaScript API, will combine map markers of close proximity to one another into clusters to simplify the display of markers on the map at various zoom levels.',
  'option_explain.xaAmsMetaDescription' => 'Enter a meta description for your Article Management System Home Page. This will be placed inside the meta description tag on the AMS Index page, so avoid using HTML.',
  'option_explain.xaAmsMinimumReviewLength' => 'If a review is entered, it will not be accepted unless it is at least this long. If a review is not required, this setting will be ignored if no review is entered.',
  'option_explain.xaAmsMoreFromAuthorLayoutType' => 'When the "Display location" above is set to "Below article", you can choose the layout type you want to use to display articles in the "More from [author]" block.
<br><br>
<b><span style="color:red;">Important Note</span></b>:  If the viewing user does not have permission to view ams article attachments, the more from author block will be rendered in List View layout type regardless of this option setting.',
  'option_explain.xaAmsMoreFromAuthorLocation' => 'Controls where the "More from [author name]" block will be displayed',
  'option_explain.xaAmsMoreInCategoryLayoutType' => 'When the "Display location" above is set to "Below article", you can choose the layout type you want to use to display articles in the "More in [category name]" block.
<br><br>
<b><span style="color:red;">Important Note</span></b>:  If the viewing user does not have permission to view ams article attachments, the more in category block will be rendered in List View layout type regardless of this option setting.',
  'option_explain.xaAmsMoreInCategoryLocation' => 'Controls where the More in [category name] block will be displayed',
  'option_explain.xaAmsOverrideStyle' => 'The style selected here will be displayed on all ams pages instead of the default style.',
  'option_explain.xaAmsRecentReviewsCount' => 'The maximum number of recent reviews to display on the main article view page. <b>Note</b>: Use 0 to disable this block.',
  'option_explain.xaAmsReviewAllowedFileExtensions' => 'List the file extensions that are allowed to be uploaded to reviews. Use spaces or line break between extensions.',
  'option_explain.xaAmsReviewAttachmentMaxFileSize' => 'Provide the maximum review attachment file size in kilobytes (KB). Attachments over this size will be rejected.',
  'option_explain.xaAmsReviewMaxLength' => 'The maximum number of characters that can be in an article review. This includes BB code. Use 0 to disable the limit.',
  'option_explain.xaAmsReviewsPerPage' => '',
  'option_explain.xaAmsSeriesArticlesPerPage' => 'The number of articles that will be listed per page on a series.',
  'option_explain.xaAmsSeriesDetailsMaxLength' => 'The maximum number of characters that can be in the series details. This includes BB code. <b>Note</b>: Use 0 to disable the limit.',
  'option_explain.xaAmsSeriesMinTags' => '',
  'option_explain.xaAmsSeriesPerPage' => 'The number of series that will be listed per page on series index and other various pages with series listings.',
  'option_explain.xaAmsShowPointsOfInterest' => 'When enabled, will include points of interest on Category maps (this is default standard with google maps).  Disable this option if you want to "clean up" the map from looking cluttered.
<br>
<b>Note</b>:  This does not apply to individual article maps.',
  'option_explain.xaAmsSignatureOnComments' => 'When enabled, signatures will display on comments just like they do on posts.',
  'option_explain.xaAmsSnippetLengthAV' => 'The number of characters of the article preview to display on the article view layout type.',
  'option_explain.xaAmsSnippetLengthFC' => 'The number of characters of the article preview to display on the featured articles carousel.',
  'option_explain.xaAmsSnippetLengthGV' => 'The number of characters of the article preview to display on the grid view layout type.',
  'option_explain.xaAmsSnippetLengthLV' => 'The number of characters of the article preview to display on the list view layout type.',
  'option_explain.xaAmsUnreadCounter' => 'If enabled, the count of unread articles will display above the "Articles" navigation tab.',
  'option_explain.xaAmsUpcomingArticlesCutOffDays' => 'Scheduled articles that will be published within X amount of days, will be displayed in the Upcoming articles block in the Articles Queue. Default is set at 14, which means articles that are scheduled to be published within the next 14 days will be displayed as Upcoming Articles.',
  'option_explain.xaAmsViewFullArticle' => 'When enabled, will add "View full article" links to various navigation elements on a multi page article, allowing the viewing user to view the full article on a single page.',
);