...
return array (
  ...
  'style_prop_desc.bbCodeBlockExpandHeight' => 'When a large quote is posted in a message, it will expand to this height before a link to expand the block further will appear',
  ...
  'style_prop_desc.bbCodeImgFloatMarginAfter' => 'This margin is used for the image side facing any wrapped text, and the bottom of the image',
  ...
  'style_prop_desc.editorBg' => 'The background for the editor before it is activated',
  'style_prop_desc.editorButtonActiveColor' => 'Color for icons when active, such as the \'B\' when the cursor is on bold text',
  'style_prop_desc.editorButtonColor' => 'Color of the icons in the toolbar',
  'style_prop_desc.editorButtonDisabledColor' => 'Color for icons that are disabled or unavailable',
  'style_prop_desc.editorButtonHoverBg' => 'Color for button background when hovered',
  'style_prop_desc.editorButtonHoverColor' => 'Color for button icons when hovered',
  'style_prop_desc.editorButtonSelectedBg' => 'Color for button background when pressed and held, or when a sub-menu is active',
  'style_prop_desc.editorButtonSize' => 'The font size for the editor button icons',
  'style_prop_desc.editorColor' => 'Color for otherwise un-styled text within the editor',
  'style_prop_desc.editorFocusBg' => 'Background color for the editor when activated',
  'style_prop_desc.editorFocusColor' => 'Color for otherwise un-styled text within the activated editor',
  'style_prop_desc.editorImageHandles' => 'Color of the border and resize handles for images selected in the editor',
  'style_prop_desc.editorSelectionBg' => 'Background color for text that has been selected in the editor',
  'style_prop_desc.editorSelectionColor' => 'When text is selected within the text editor, it will use this color',
  'style_prop_desc.editorToolsBg' => 'Background for the toolbar when the editor is not focused',
  'style_prop_desc.editorToolsFocusBg' => 'The background of the toolbar when the editor is focused',
  'style_prop_desc.editorToolsOverflowBg' => 'Used for the supplemental toolbars that contain overflowed buttons from the main toolbar, and for the header of popup tool windows',
  ...
  'style_prop_desc.emailPublicLogoUrl' => 'Defines the logo URL to be used in emails. We do not recommend specifying SVG images here.',
  ...
  'style_prop_desc.memberHeaderNameBanner' => 'Styling for the name of the user whose tooltip is being displayed if the user has uploaded a profile banner',
  ...
  'style_prop_desc.memberTooltipNameBanner' => 'Styling for the name of the user whose tooltip is being displayed if the user has uploaded a profile banner',
  ...
  'style_prop_desc.metaThemeColor' => 'This sets the theme color used for PWA installations, as well as the address bar color on Chrome for Android.',
  ...
  'style_prop_desc.noticeScrollInterval' => 'Mỗi thông báo có thể cuộn sẽ được hiển thị cho khoảng thời gian này trước khi hiển thị tiếp theo. Di chuột hoặc tương tác với các thông báo sẽ ngăn việc tự động cuộn xuống.',
  ...
  'style_prop_desc.pageNavStyle' => 'This controls the appearance of page navigation. "Simple" focuses on the current page and is good for touch devices. "Standard" shows relative page numbers and is good for desktops. "Mixed" switches between them based on device size.',
  ...
  'style_prop_desc.publicFaviconUrl' => 'Path to the small logo that is associated with bookmarks pointing to your site. This is expected to be a 32x32 PNG image.',
  ...
  'style_prop_desc.publicIconUrl' => 'The path to your icon image. This should be a 192x192 image and usually a PNG.',
  'style_prop_desc.publicIconUrlLarge' => 'The path to your large icon image. This should be a 512x512 image and usually a PNG.',
  'style_prop_desc.publicIconsMaskable' => 'If enabled, you are indicating that the icons above respect the <a href="https://web.dev/maskable-icon/" target="_blank">minimum safe zone</a> and can be cropped to the appropriate icon size for various devices.',
  'style_prop_desc.publicLogoHeight' => 'If you specify the height of your logo here, you can avoid a costly re-flow of your page layout once the logo loads.',
  'style_prop_desc.publicLogoUrl' => 'The web path from your site\'s XenForo installation directory to your logo image. If you specify an SVG image here, you should set <b>Emails &gt; Email logo URL</b> to point to a PNG image, or similar, for increased compatibility.',
  'style_prop_desc.publicLogoUrl2x' => 'The path to a double-resolution / retina version of your logo image',
  'style_prop_desc.publicLogoWidth' => 'If you specify the width of your logo here, you can avoid a costly re-flow of your page layout once the logo loads.',
  ...
  'style_prop_desc.xaAmsArticleViewLayoutElements' => 'The elements selected here will be displayed on the Article View Layout.',
  'style_prop_desc.xaAmsArticlesCarouselElements' => 'The elements selected here will be displayed on widgets created with the AMS: Latest articles widget definition and display style "Full - Carousel"',
  'style_prop_desc.xaAmsArticlesCarouselShowType' => 'This setting allows you to choose whether to show 1 article at a time or 2 articles at a time.',
  'style_prop_desc.xaAmsArticlesCarouselSimpleElements' => 'The elements selected here will be displayed on widgets created with the AMS: Featured or Latest articles widget definition and display style "Simple - Carousel"',
  'style_prop_desc.xaAmsArticlesGridBlockElements' => 'The elements selected here will be displayed on the Latest Articles Grid Block.',
  'style_prop_desc.xaAmsFeaturedArticlesGridBlockElements' => 'The elements selected here will be displayed on the Featured Articles Grid Block.',
  'style_prop_desc.xaAmsFeaturedCarouselElements' => 'The elements selected here will be displayed on the Featured Carousel on AMS Index, AMS Category pages and AMS Featured Carousel Widgets.',
  'style_prop_desc.xaAmsFeaturedCarouselShowType' => 'This setting allows you to choose whether to show 1 article at a time or 2 articles at a time.',
  'style_prop_desc.xaAmsGridViewLayoutElements' => 'The elements selected here will be displayed on the Grid View Layout.',
  'style_prop_desc.xaAmsListViewLayoutElements' => 'The elements selected here will be displayed on the List View Layout.',
  'style_prop_desc.xaAmsShareThisArticleBlockElements' => 'Enable/disable the "Share this article" block and choose which additional elements display in the block.',
  'style_prop_desc.xaAmsTileViewLayoutElements' => 'The elements selected here will be displayed on the Tile View Layout.',
