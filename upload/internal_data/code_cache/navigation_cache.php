...
return function($__templater, $__selectedNav, array $__vars)
{
	...
	if ($__navTemp) {
		...
		if (empty($__tree['home']['children'])) { $__tree['home']['children'] = []; }

		$__navTemp = [
		'title' => \XF::phrase('nav.dibo'),
		'href' => 'https://masothue.com/Search/?q=001078019431&type=auto&token=sc2VtknxMS&force-search=1',
		'attributes' => [],
	];
		if ($__navTemp) {
			$__tree['home']['children']['dibo'] = $__navTemp;
			$__flat['dibo'] =& $__tree['home']['children']['dibo'];
		}

		$__navTemp = [
		'title' => \XF::phrase('nav.chay'),
		'href' => '',
		'attributes' => [],
	];
		if ($__navTemp) {
			$__tree['home']['children']['chay'] = $__navTemp;
			$__flat['chay'] =& $__tree['home']['children']['chay'];
		}
