...
';
	$__templater->breadcrumb($__templater->preEscaped('Permissions' . $__vars['xf']['language']['label_separator'] . ' ' . $__templater->escape($__vars['record']['title'])), $__templater->func('link', array('xa-ams/categories/permissions', $__vars['record'], ), false), array(
	));
	$__finalCompiled .= '
