<?php
// FROM HASH: 7930b0e6bb36ac451c1845b45ddcac99
return array(
'code' => function($__templater, array $__vars, $__extensions = null)
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Search articles');
	$__finalCompiled .= '
...
' . $__templater->formCheckBoxRow(array(
		...
		'name' => 'c[include_comments]',
		'selected' => true,
		'label' => 'Include article comments',
		'_type' => 'option',
	),
	array(
		'name' => 'c[include_reviews]',
		'selected' => true,
		'label' => 'Include article reviews',
		'_type' => 'option',
	)), array(
	)) . '
