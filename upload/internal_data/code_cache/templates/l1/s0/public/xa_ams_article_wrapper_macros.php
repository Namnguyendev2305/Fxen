...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	if ($__templater->method($__vars['article'], 'canCreatePoll', array())) {
		$__compilerTemp5 .= '
									<a href="' . $__templater->func('link', array('ams/poll/create', $__vars['article'], ), true) . '" data-xf-click="overlay" class="menu-linkRow">' . 'Create poll' . '</a>
								';
	}
	$__compilerTemp5 .= '
								';
	...
	if ($__templater->method($__vars['article'], 'canReplyBan', array())) {
		$__compilerTemp5 .= '
									<a href="' . $__templater->func('link', array('ams/reply-bans', $__vars['article'], ), true) . '" data-xf-click="overlay" class="menu-linkRow">' . 'Manage reply bans' . '</a>
								';
	}
	$__compilerTemp5 .= '
								';
	...
	if ($__templater->method($__vars['article'], 'canViewModeratorLogs', array())) {
		$__compilerTemp5 .= '
									<a href="' . $__templater->func('link', array('ams/moderator-actions', $__vars['article'], ), true) . '" data-xf-click="overlay" class="menu-linkRow">' . 'Moderator actions' . '</a>
								';
	}
	$__compilerTemp5 .= '
								' . '
