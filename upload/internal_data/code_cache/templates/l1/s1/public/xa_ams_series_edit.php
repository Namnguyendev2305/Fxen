<?php
// FROM HASH: 76f3ded86b9fca1f7d7f3659d41416f9
return array(
...
';
	...
	<div class="block-container">
		...
		'label' => 'Title',
			...
			' . $__templater->callMacro('xa_ams_series_edit_macros', 'message', array(
		...
		'attachmentData' => $__vars['attachmentData'],
			...
			' . $__templater->callMacro('xa_ams_series_edit_macros', 'description', array(
		...
		'afterhint' => 'When enabled, allows other members of the community to add their own article(s) to this series. ',
		'_type' => 'option',
	)), array(
	)) . '
		...
		<div class="block-body block-body--collapsible">
			' . $__templater->callMacro('xa_ams_series_edit_macros', 'og_title_meta_title', array(
		'series' => $__vars['series'],
	), $__vars) . '			
			' . $__templater->callMacro('xa_ams_series_edit_macros', 'meta_description', array(
		'series' => $__vars['series'],
	), $__vars) . '
		</div>			
...
', array(
		'action' => $__templater->func('link', array('ams/series/edit', $__vars['series'], ), false),
		'ajax' => 'true',
		'class' => 'block',
		'data-preview-url' => $__templater->func('link', array('ams/series/preview', $__vars['series'], ), false),
	));
