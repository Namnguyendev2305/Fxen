	...
	if ($__templater->method($__vars['content'], 'canReplyToComment', array())) {
		...
		$__compilerTemp2 .= '
													<a href="' . $__templater->escape($__vars['quoteLink']) . '"
														...
														data-xf-click="quote"
														data-quote-href="' . $__templater->func('link', array('ams/comments/quote', $__vars['comment'], ), true) . '">' . 'Reply' . '</a>
												';
	}
	$__compilerTemp2 .= '
											';
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	<section class="message message--simple message--deleted message--comment' . ($__templater->method($__vars['comment'], 'isIgnored', array()) ? ' is-ignored' : '') . ' js-comment js-inlineModContainer"
		...
		'log' => $__vars['comment']['DeletionLog'],
					...
					<a href="' . $__templater->func('link', array('ams/comments/show', $__vars['comment'], ), true) . '" class="u-jsOnly" data-xf-click="inserter" data-replace="[data-content=ams-comment-' . $__templater->escape($__vars['comment']['comment_id']) . ']">' . 'Show' . $__vars['xf']['language']['ellipsis'] . '</a>
				</div>
			</div>
		</div>
	</section>
