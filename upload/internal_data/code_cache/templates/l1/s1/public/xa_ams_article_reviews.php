...
<div class="block block--messages"
		...
		<div class="block-tabHeader tabs">
			<div class="hScroller" data-xf-init="h-scroller">
				<span class="hScroller-scroll">
					' . '
					<a href="' . $__templater->func('link', array('ams/reviews', $__vars['article'], $__vars['reviewTabs']['latest']['filters'], ), true) . '" class="tabs-tab ' . ($__vars['reviewTabs']['latest']['selected'] ? 'is-active' : '') . '">' . 'Latest' . '</a>
					';
	...
	$__finalCompiled .= '
					<a href="' . $__templater->func('link', array('ams/reviews', $__vars['article'], $__vars['reviewTabs']['rating']['filters'], ), true) . '" class="tabs-tab ' . ($__vars['reviewTabs']['rating']['selected'] ? 'is-active' : '') . '">' . 'Rating' . '</a>
					' . '
				</span>
			</div>
