...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	if ($__templater->method($__vars['series'], 'canCreatePoll', array())) {
		$__compilerTemp3 .= '
									<a href="' . $__templater->func('link', array('ams/series/poll/create', $__vars['series'], ), true) . '" data-xf-click="overlay" class="menu-linkRow">' . 'Create poll' . '</a>
								';
	}
	$__compilerTemp3 .= '
								';
	if ($__templater->method($__vars['series'], 'canViewModeratorLogs', array())) {
		$__compilerTemp3 .= '
									<a href="' . $__templater->func('link', array('ams/series/moderator-actions', $__vars['series'], ), true) . '" data-xf-click="overlay" class="menu-linkRow">' . 'Moderator actions' . '</a>
								';
	}
	$__compilerTemp3 .= '											
								' . '
