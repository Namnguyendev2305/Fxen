...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	<a class="' . $__templater->escape($__vars['baseClass']) . ' ' . (((($__vars['pageSelected'] == 'started') AND ($__vars['xf']['visitor']['user_id'] == $__vars['user']['user_id']))) ? $__templater->escape($__vars['selectedClass']) : '') . '"
		href="' . $__templater->func('link', array('find-threads/started', ), true) . '" rel="nofollow">' . 'Chủ đề của bạn' . '</a>
	<a class="' . $__templater->escape($__vars['baseClass']) . ' ' . (($__vars['pageSelected'] == 'contributed') ? $__templater->escape($__vars['selectedClass']) : '') . '"
		href="' . $__templater->func('link', array('find-threads/contributed', ), true) . '" rel="nofollow">' . 'Chủ đề với bình luận của bạn' . '</a>
	<a class="' . $__templater->escape($__vars['baseClass']) . ' ' . (($__vars['pageSelected'] == 'unanswered') ? $__templater->escape($__vars['selectedClass']) : '') . '"
		href="' . $__templater->func('link', array('find-threads/unanswered', ), true) . '" rel="nofollow">' . 'Chủ đề chưa trả lời' . '</a>
	<a class="' . $__templater->escape($__vars['baseClass']) . ' ' . (($__vars['pageSelected'] == 'watched') ? $__templater->escape($__vars['selectedClass']) : '') . '"
		href="' . $__templater->func('link', array('watched/threads', ), true) . '" rel="nofollow">' . 'Chủ đề đã theo dõi' . '</a>
';
	return $__finalCompiled;
}
)),
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	if ($__vars['pageSelected'] == 'started') {
		$__finalCompiled .= '
	';
		$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Chủ đề được tạo bởi ' . $__templater->escape($__vars['user']['username']) . '');
...
';
		...
		$__finalCompiled .= '
	';
		$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Chủ đề với bài viết của ' . $__templater->escape($__vars['user']['username']) . '');
		$__templater->pageParams['pageNumber'] = $__vars['page'];
		$__finalCompiled .= '
';
	} else {
		$__finalCompiled .= '
	';
		$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Chủ đề không có trả lời');
		$__templater->pageParams['pageNumber'] = $__vars['page'];
		$__finalCompiled .= '
	';
...
';
		...
		$__finalCompiled .= '
	<div class="blockMessage">' . 'Không có chủ đề nào được hiển thị.' . '</div>
';
	}
	$__finalCompiled .= '
