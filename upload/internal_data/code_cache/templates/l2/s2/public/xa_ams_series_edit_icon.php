<?php
// FROM HASH: 7938e8abb4d38c21df2acd751ebd893e
return array(
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	<dfn class="inputChoices-explain">
		' . 'Bạn nên sử dụng hình ảnh có kích thước tối thiểu ' . 200 . 'x' . 200 . ' pixels.' . '
	</dfn>
';
	return $__finalCompiled;
}
...
', array(
		'action' => $__templater->func('link', array('ams/series/edit-icon', $__vars['series'], ), false),
		'upload' => 'true',
		'ajax' => 'true',
		'class' => 'block',
	)) . '
