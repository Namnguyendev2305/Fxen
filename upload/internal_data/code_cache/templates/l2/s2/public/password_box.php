...
<div data-xf-init="' . ($__vars['checkStrength'] ? 'password-strength' : null) . ' ' . ($__vars['hideShow'] ? 'password-hide-show' : '') . '"
	...
	if ($__vars['checkStrength']) {
		...
		<span class="js-strengthText meterBarLabel">' . 'Nhập mật khẩu là bắt buộc.' . '</span>
		<script class="js-zxcvbnLanguage" type="application/json">
			{
				...
				"Entering a password is required": "' . $__templater->filter('Nhập mật khẩu là bắt buộc.', array(array('escape', array('json', )),), true) . '",
