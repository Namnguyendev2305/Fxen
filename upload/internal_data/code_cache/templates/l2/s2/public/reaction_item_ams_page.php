<?php
// FROM HASH: 32d6ee1408a77e572548f922bb579c3e
return array(
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	if ($__vars['page']['user_id'] == $__vars['xf']['visitor']['user_id']) {
		$__finalCompiled .= '
			' . '' . $__templater->func('username_link', array($__vars['reactionUser'], false, array('defaultname' => $__vars['fallbackName'], ), ), true) . ' reacted to your page ' . (((('<a href="' . $__templater->func('link', array('ams/page', $__vars['page'], ), true)) . '" class="fauxBlockLink-blockLink">') . $__templater->escape($__vars['page']['title'])) . '</a>') . ' on the article ' . (((('<a href="' . $__templater->func('link', array('ams/page', $__vars['page'], ), true)) . '">') . $__templater->escape($__vars['page']['Content']['title'])) . '</a>') . ' with ' . $__templater->filter($__templater->func('alert_reaction', array($__vars['reactionId'], 'medium', ), false), array(array('preescaped', array()),), true) . '.' . '
		';
	} else {
		$__finalCompiled .= '
			' . '' . $__templater->func('username_link', array($__vars['reactionUser'], false, array('defaultname' => $__vars['fallbackName'], ), ), true) . ' reacted to ' . $__templater->escape($__vars['page']['username']) . '\'s page ' . (((('<a href="' . $__templater->func('link', array('ams/page', $__vars['page'], ), true)) . '" class="fauxBlockLink-blockLink">') . $__templater->escape($__vars['page']['title'])) . '</a>') . ' on the article ' . (((('<a href="' . $__templater->func('link', array('ams/page', $__vars['page'], ), true)) . '">') . $__templater->escape($__vars['page']['Content']['title'])) . '</a>') . ' with ' . $__templater->filter($__templater->func('alert_reaction', array($__vars['reactionId'], 'medium', ), false), array(array('preescaped', array()),), true) . '.' . '
		';
	}
	$__finalCompiled .= '
	</div>
