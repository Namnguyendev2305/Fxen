...
'code' => function($__templater, array $__vars, $__extensions = null)
{
		...
		$__compilerTemp1 .= '
			' . $__templater->formRow('
				<div class="block-rowMessage block-rowMessage--important block-rowMessage--small">
					<a href="' . $__templater->func('link', array('forums/post-thread', $__vars['forum'], ), true) . '">' . 'Bạn có một bản nháp đã lưu. Nhấp vào đây để tải nó' . '</a>
				</div>
			', array(
	...
	<div class="js-quickThreadFields" data-xf-init="attachment-manager">
		...
		'data-min-height' => '100',
		'data-max-height' => '300',
		'placeholder' => 'Nội dung' . $__vars['xf']['language']['ellipsis'],
		...
		'icon' => 'write',
				...
				' . $__templater->button('Thêm tùy chọn' . $__vars['xf']['language']['ellipsis'], array(
		'type' => 'submit',
		'formnovalidate' => 'formnovalidate',
		'name' => 'more-options',
		'value' => '1',
		'title' => 'Hiển thị trình chỉnh sửa chủ đề mới đầy đủ với các tùy chọn đính kèm tệp, tạo phiếu thăm dò và hơn thế nữa',
