...
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Tạo cuộc trò chuyện');
	$__finalCompiled .= '
...
';
	...
	<div class="block-container">
		...
		'rowtype' => 'fullWidth',
		'label' => (((($__vars['maxRecipients'] == -1) OR ($__vars['maxRecipients'] > 1))) ? 'Người nhận' : 'Người nhận'),
		'explain' => (((($__vars['maxRecipients'] == -1) OR ($__vars['maxRecipients'] > 1))) ? 'Phân tách các tên bằng dấu (,).' : null),
	)) . '
