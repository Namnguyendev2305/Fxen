...
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped($__templater->escape($__vars['title']) . ' - ' . 'Chỉnh sửa lịch sửa');
	$__finalCompiled .= '
	...
	array(
		...
		<div class="block-footer">
			<span class="block-footer-controls">
				' . $__templater->button('So sánh các phiên bản', array(
		'type' => 'submit',
		'name' => 'compare',
		'value' => '1',
