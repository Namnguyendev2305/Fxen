...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	' . $__templater->formTextBoxRow(array(
		...
		'hint' => ($__vars['article']['Category']['require_original_source'] ? '(Yêu cầu)' : 'Tùy chọn (không bắt buộc)'),
	)) . '
';
	return $__finalCompiled;
}
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	' . $__templater->formTextBoxRow(array(
		...
		'label' => 'Nơi ở',
		'hint' => ($__vars['article']['Category']['require_location'] ? '(Yêu cầu)' : 'Tùy chọn (không bắt buộc)'),
