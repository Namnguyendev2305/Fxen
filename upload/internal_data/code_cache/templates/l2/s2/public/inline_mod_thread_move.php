...
';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Kiểm duyệt trực tuyến - Di chuyển chủ đề');
	$__finalCompiled .= '
...
';
	...
	<div class="block-container">
		<div class="block-body js-prefixListenContainer">
			' . $__templater->formInfoRow('Bạn có chắc chắn muốn di chuyển ' . $__templater->escape($__vars['total']) . ' chủ đề?', array(
		'rowtype' => 'confirm',
	)) . '
...
',
		...
		'label' => 'Thêm tiền tố cho chủ đề đã chọn',
		'_dependent' => array('
