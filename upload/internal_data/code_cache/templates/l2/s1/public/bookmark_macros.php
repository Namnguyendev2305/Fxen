<?php
// FROM HASH: 27a9342043329865d3ce4e6500fe87eb
return array(
	...
	<div class="contentRow-extra">
		...
		<div class="menu" data-menu="menu" aria-hidden="true">
			<div class="menu-content">
				...
				<a class="menu-linkRow is-hidden" role="button" tabindex="0" data-menu-closer="on" data-xf-init="copy-to-clipboard" data-copy-text="' . $__templater->escape($__vars['bookmark']['content_link']) . '">' . 'Sao chép liên kết' . '</a>
				<a href="' . $__templater->escape($__vars['bookmark']['edit_link']) . '" class="menu-linkRow" data-xf-click="overlay">' . 'Chỉnh sửa' . '</a>
				<a href="' . $__templater->escape($__vars['bookmark']['delete_link']) . '" class="menu-linkRow" data-xf-click="overlay">' . 'Xóa' . '</a>
			</div>
		</div>
	</div>
';
	...
	if ($__vars['bookmark']['content_user'] OR $__templater->method($__vars['content'], 'isValidKey', array('username', ))) {
		$__finalCompiled .= '
			...
			'title' => 'Thành viên',
					...
					<span class="u-srOnly">' . 'Thành viên' . '</span>
...
'arguments' => function($__templater, array $__vars) { return array(
		...
		'minLength' => '0',
		'maxTokens' => '1',
		'placeholder' => 'Lọc theo nhãn' . $__vars['xf']['language']['ellipsis'],
	); },
'code' => function($__templater, array $__vars, $__extensions = null)
{
	$__finalCompiled = '';
