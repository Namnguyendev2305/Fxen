<?php
// FROM HASH: b073a64107b0f174ed19f1133a143748
return array(
		...
		<div class="file-content">
			<div class="file-info">
				...
				<div class="file-meta">
					...
					';
	if ((!$__vars['attachment']['is_video']) AND (!$__vars['attachment']['is_audio'])) {
		$__finalCompiled .= '
					&middot; ' . 'Lượt xem' . $__vars['xf']['language']['label_separator'] . ' ' . $__templater->filter($__vars['attachment']['view_count'], array(array('number', array()),), true) . '
					';
	}
	$__finalCompiled .= '
				</div>
