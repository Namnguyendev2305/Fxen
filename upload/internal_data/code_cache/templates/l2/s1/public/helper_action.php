...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	$__vars['checkbox'] = $__templater->preEscaped('
		...
		'afterhint' => 'Lưu ý rằng tác giả sẽ thấy cảnh cáo này ngay cả khi họ không còn có thể xem nội dung của họ.',
		'_type' => 'option',
	))) . '
	');
	$__finalCompiled .= '
...
' . ' ' . 'Lý do' . $__vars['xf']['language']['label_separator'],
		...
		'afterhint' => 'Lưu ý rằng người tạo chủ đề sẽ nhìn thấy cảnh cáo ngay cả khi họ không còn xem được chủ đề của họ.',
		'_type' => 'option',
	)), array(
	)) . '
';
