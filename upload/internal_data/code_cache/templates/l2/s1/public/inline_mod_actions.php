...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	<div class="inlineModBar-inner">
		...
		'aria-label' => $__templater->filter('Đóng', array(array('for_attr', array()),), false),
	), '', array(
	)) . '
		</div>
		...
		'_type' => 'option',
			...
			<li>
				<select class="input input--inline js-inlineModAction">
					<optgroup>
						<option value="" hidden="hidden">' . 'Chọn hành động' . $__vars['xf']['language']['ellipsis'] . '</option>
						';
	...
	if (!$__vars['actions']['deselect']) {
		$__finalCompiled .= '
						<optgroup>
							<option value="deselect">' . 'Bỏ chọn tất cả' . '</option>
						</optgroup>
					';
	}
	$__finalCompiled .= '
