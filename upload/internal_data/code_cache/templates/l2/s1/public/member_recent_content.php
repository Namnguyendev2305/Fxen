...
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Nội dung mới nhất bởi ' . $__templater->escape($__vars['user']['username']) . '');
	$__finalCompiled .= '
...
';
		...
		$__finalCompiled .= '
	<div class="blockMessage">' . '' . $__templater->escape($__vars['user']['username']) . ' chưa đăng bất kỳ nội dung nào gần đây.' . '</div>
';
	}
