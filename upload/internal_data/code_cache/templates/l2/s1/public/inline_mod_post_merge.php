...
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Quản lý trực tuyến - Gộp các bài viết');
	$__finalCompiled .= '
...
';
	...
	<div class="block-container">
		<div class="block-body">
			' . $__templater->formInfoRow('Bạn có chắc muốn gộp ' . $__templater->escape($__vars['total']) . ' bài viết lại?', array(
		'rowtype' => 'confirm',
	)) . '
