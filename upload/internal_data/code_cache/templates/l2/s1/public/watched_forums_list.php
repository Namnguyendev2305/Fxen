...
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Diễn đàn đã theo dõi');
	$__finalCompiled .= '
			...
			'aria-haspopup' => 'true',
				...
				<div class="menu" data-menu="menu" aria-hidden="true">
					<div class="menu-content">
						...
						' . '
						<a href="' . $__templater->func('link', array('watched/forums/manage', null, array('state' => 'watch_no_email', ), ), true) . '" data-xf-click="overlay" class="menu-linkRow">' . 'Tắt thông báo email' . '</a>
...
';
		...
		$__finalCompiled .= '
	<div class="blockMessage">' . 'Bạn không theo dõi bất kỳ một diễn đàn nào.' . '</div>
';
	}
