<?php
// FROM HASH: a001af6216bf7c28d0e52b70f8476112
return array(
...
'thread_action_buttons' => function($__templater, array $__vars, $__extensions = null)
{
	...
	if ($__templater->method($__vars['thread'], 'canChangeType', array()) AND ($__templater->func('count', array($__vars['creatableThreadTypes'], ), false) > 1)) {
		$__compilerTemp2 .= '
												<a href="' . $__templater->func('link', array('threads/change-type', $__vars['thread'], ), true) . '" data-xf-click="overlay" class="menu-linkRow">' . 'Thay đổi loại chủ đề' . '</a>
											';
	}
	$__compilerTemp2 .= '
											';
	...
	if ($__templater->method($__vars['thread'], 'canReplyBan', array())) {
		$__compilerTemp2 .= '
												<a href="' . $__templater->func('link', array('threads/reply-bans', $__vars['thread'], ), true) . '" data-xf-click="overlay" class="menu-linkRow">' . 'Phản hồi lệnh cấm' . '</a>
											';
	}
	$__compilerTemp2 .= '
											';
...
';
	...
	<ul class="listInline listInline--bullet">
		...
		'title' => $__templater->filter('Người khởi tạo', array(array('for_attr', array()),), false),
	)) . '
