...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	if ($__vars['page']['CoverImage']) {
		...
		$__finalCompiled .= '
			...
			'defaultname' => ($__vars['page']['username'] ?: 'Thành viên đã bị xoá'),
		))) . '
			';
	}
	$__finalCompiled .= '
	...
	$__finalCompiled .= '					
					<li>' . 'Chuyên mục' . $__vars['xf']['language']['label_separator'] . ' <a href="' . $__templater->func('link', array('ams/categories', $__vars['page']['Article']['Category'], ), true) . '">' . $__templater->escape($__vars['page']['Article']['Category']['title']) . '</a></li>
				</ul>
			</div>
		</div>
	</div>
