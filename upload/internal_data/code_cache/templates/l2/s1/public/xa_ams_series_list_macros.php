...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	';
	$__vars['sortOrders'] = array('last_part_date' => 'Latest article', 'create_date' => 'Create date', 'article_count' => 'Articles', 'title' => 'Tiêu đề', );
	$__finalCompiled .= '
		...
		if ($__templater->isTraversable($__vars['series'])) {
			foreach ($__vars['series'] AS $__vars['seriesItem']) {
				...
				if ($__vars['seriesItem']['last_part_date'] AND ($__vars['seriesItem']['last_part_date'] > $__vars['seriesItem']['create_date'])) {
					$__finalCompiled .= '
												<li>' . 'Cập nhật' . ' <a href="' . $__templater->func('link', array('ams/series', $__vars['seriesItem'], ), true) . '" rel="nofollow" class="u-concealed">' . $__templater->func('date_dynamic', array($__vars['seriesItem']['last_part_date'], array(
					))) . '</a></li>
											';
				}
				$__finalCompiled .= '
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	if ($__vars['withMeta']) {
		...
		if ($__vars['series']['LastArticle']) {
			$__finalCompiled .= '
							<li>' . 'Cập nhật' . $__vars['xf']['language']['label_separator'] . ' ' . $__templater->func('date_dynamic', array($__vars['series']['last_part_date'], array(
			))) . '</li>
							<li>
								' . 'Latest article' . ': <a href="' . $__templater->func('link', array('ams', $__vars['series']['LastArticle'], ), true) . '" class="">' . $__templater->escape($__vars['series']['LastArticle']['title']) . '</a>
							</li>
