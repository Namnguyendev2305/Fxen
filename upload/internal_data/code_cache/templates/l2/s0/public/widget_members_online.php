	...
	';
		...
		<div class="block" data-widget-section="staffMembers"' . $__templater->func('widget_data', array($__vars['widget'], ), true) . '>
			<div class="block-container">
				<h3 class="block-minorHeader"><a href="' . $__templater->func('link', array('members', null, array('key' => 'staff_members', ), ), true) . '">' . 'BQT trực tuyến' . '</a></h3>
				<ul class="block-body">
				' . $__compilerTemp1 . '
				</ul>
			</div>
...
<div class="block" data-widget-section="onlineNow"' . $__templater->func('widget_data', array($__vars['widget'], ), true) . '>
	...
	if (!$__templater->test($__vars['online']['users'], 'empty', array())) {
		...
		if ($__vars['online']['counts']['unseen']) {
			$__finalCompiled .= '
						<a href="' . $__templater->func('link', array('online', ), true) . '">' . '... và ' . $__templater->escape($__vars['online']['counts']['unseen']) . ' nữa.' . '</a>
					';
		}
		$__finalCompiled .= '
				';
	...
	$__finalCompiled .= '
		...
		<div class="block-footer">
			<span class="block-footer-counter">' . 'Tổng:&nbsp;' . $__templater->func('number', array($__vars['online']['counts']['total'], ), true) . ' (Thành viên:&nbsp;' . $__templater->func('number', array($__vars['online']['counts']['members'], ), true) . ', khách:&nbsp;' . $__templater->func('number', array($__vars['online']['counts']['guests'], ), true) . ')' . '</span>
		</div>
	</div>
</div>';
