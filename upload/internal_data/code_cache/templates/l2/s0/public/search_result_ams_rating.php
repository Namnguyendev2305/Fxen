...
{
	$__finalCompiled = '';
	$__finalCompiled .= '<li class="block-row block-row--separated ' . ($__templater->method($__vars['review'], 'isIgnored', array()) ? 'is-ignored' : '') . ' js-inlineModContainer" data-author="' . (($__vars['review']['is_anonymous'] ? 'Vô danh' : $__templater->escape($__vars['review']['User']['username'])) ?: $__templater->escape($__vars['review']['username'])) . '">
	...
	if ($__vars['review']['is_anonymous']) {
		...
		$__finalCompiled .= '
			...
			'defaultname' => ($__vars['review']['username'] ?: 'Thành viên đã bị xoá'),
		))) . '
			';
	}
	$__finalCompiled .= '
		...
		<div class="contentRow-main">
			<h3 class="contentRow-title">
				<a href="' . $__templater->func('link', array('ams/review', $__vars['review'], ), true) . '">
					' . 'Review by \'' . ($__vars['review']['is_anonymous'] ? 'Vô danh' : $__templater->escape($__vars['review']['username'])) . '\' in article \'' . $__templater->escape($__vars['review']['Article']['title']) . '\'' . '
				</a>
			</h3>
