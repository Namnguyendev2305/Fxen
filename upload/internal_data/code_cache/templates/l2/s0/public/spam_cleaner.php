<?php
// FROM HASH: c77853711f27e4a3caec6a9061c726bd
return array(
'code' => function($__templater, array $__vars, $__extensions = null)
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Dọn dẹp spam' . $__vars['xf']['language']['label_separator'] . ' ' . $__templater->escape($__vars['user']['username']));
	$__finalCompiled .= '
	...
	if ($__templater->method($__vars['xf']['visitor'], 'hasAdminPermission', array('user', )) AND $__vars['user']['email']) {
		$__compilerTemp1 .= '
							<dl class="pairs pairs--columns">
								<dt>' . 'Email' . '</dt>
								<dd>' . $__templater->filter($__vars['user']['email'], array(array('email_display', array()),), true) . '</dd>
							</dl>
						';
	}
	$__compilerTemp2 = '';
