<?php
// FROM HASH: 392c5f7cb1a910597dcbfe57b9e833dc
return array(
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	if ($__vars['isWatched']) {
		$__finalCompiled .= '
	';
		$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Bỏ theo dõi chuyên mục');
		$__finalCompiled .= '
';
	} else {
		$__finalCompiled .= '
	...
	if ($__vars['isWatched']) {
		$__compilerTemp1 .= '
				' . $__templater->formInfoRow('
					' . 'Bạn có chắc chắn muốn bỏ theo dõi danh mục này không?' . '
				', array(
			'rowtype' => 'confirm',
		)) . '
...
', array(
		'action' => $__templater->func('link', array('ams/categories/watch', $__vars['category'], ), false),
		'class' => 'block',
		'ajax' => 'true',
	));
