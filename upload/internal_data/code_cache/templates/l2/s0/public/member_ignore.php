...
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped(($__vars['isIgnoring'] ? 'Stop ignoring ' . $__templater->escape($__vars['user']['username']) . '' : 'Lờ đi ' . $__templater->escape($__vars['user']['username']) . ''));
	$__finalCompiled .= '
...
';
	...
	<div class="block-container">
		...
		'submit' => ($__vars['isIgnoring'] ? 'Bỏ ra khỏi danh sách đen' : 'Lờ đi'),
	), array(
		'rowtype' => 'simple',
	)) . '
	</div>
