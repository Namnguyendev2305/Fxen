<?php
// FROM HASH: 33037e609552cbd3a666c87ab5abc75e
return array(
...
'extensions' => array('icon_cell' => function($__templater, array $__vars, $__extensions = null)
{
	...
	if ($__templater->method($__vars['thread'], 'getUserPostCount', array())) {
		$__finalCompiled .= '
			...
			'data-trigger' => 'auto',
			'title' => 'Bạn đã đăng ' . $__templater->method($__vars['thread'], 'getUserPostCount', array()) . ' bài viết trong chủ đề này',
		))) . '
				';
	}
	$__finalCompiled .= '
...
'thread_type_redirect' => function($__templater, array $__vars, $__extensions = null)
{
	$__finalCompiled = '';
		$__finalCompiled .= '
							<li>
								<i class="structItem-status structItem-status--redirect" aria-hidden="true" title="' . $__templater->filter('Chuyển tiếp', array(array('for_attr', array()),), true) . '"></i>
	...
	$__finalCompiled .= '
			...
			<div class="contentRow-minor contentRow-minor--hideLinks">
				<ul class="listInline listInline--bullet">
					<li>' . 'Mới nhất: ' . $__templater->escape($__vars['thread']['last_post_cache']['username']) . '' . '</li>
		...
		<div class="contentRow-main contentRow-main--close">
			...
			<div class="contentRow-minor contentRow-minor--hideLinks">
				<ul class="listInline listInline--bullet">
					...
					<li>' . 'Trả lời' . $__vars['xf']['language']['label_separator'] . ' ' . $__templater->filter($__vars['thread']['reply_count'], array(array('number_short', array()),), true) . '</li>
				</ul>
			</div>
			<div class="contentRow-minor contentRow-minor--hideLinks">
				<a href="' . $__templater->func('link', array('forums', $__vars['thread']['Forum'], ), true) . '">' . $__templater->escape($__vars['thread']['Forum']['title']) . '</a>
...
'main_cell' => function($__templater, array $__vars, $__extensions = null)
{
	$__finalCompiled = '';
		...
		'title' => 'Đăng một chủ đề mới trong diễn đàn này',
		...
		'label' => 'Tiêu đề',
				...
				<div class="js-quickThreadFields inserter-container is-hidden"><!--' . 'Đang tải' . $__vars['xf']['language']['ellipsis'] . '--></div>
			</div>
		';
	return $__finalCompiled;
}),
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	';
	if ($__templater->method($__vars['xf']['cookieConsent'], 'isCaptchaConsented', array()) AND (($__templater->method($__vars['forum'], 'canCreateThread', array()) OR $__templater->method($__vars['forum'], 'canCreateThreadPreReg', array())))) {
		$__finalCompiled .= '
