...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	if ($__vars['xf']['visitor']['user_id']) {
		$__finalCompiled .= '
                ...
                <a class="blockLink rippleButton" href="' . $__templater->func('link', array('account/account-details', ), true) . '">' . 'Thông tin tài khoản' . '</a>
                <a class="blockLink rippleButton" href="' . $__templater->func('link', array('whats-new/news-feed', ), true) . '">' . 'Luồng tin' . '</a>
