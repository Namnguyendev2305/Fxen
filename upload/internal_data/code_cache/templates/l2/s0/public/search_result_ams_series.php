<?php
// FROM HASH: 5658cd307778a5402e16be4406d8598c
return array(
	...
	if ($__vars['series']['icon_date']) {
		$__finalCompiled .= '
				<a href="' . $__templater->func('link', array('ams/series', $__vars['series'], ), true) . '">
					' . $__templater->func('ams_series_icon', array($__vars['series'], ), true) . '
				</a>				
			';
	} else {
		$__finalCompiled .= '
	...
	$__finalCompiled .= '					
			...
			<div class="contentRow-minor contentRow-minor--hideLinks">
				<ul class="listInline listInline--bullet">
					';
	if (($__vars['options']['mod'] == 'ams_series') AND $__templater->method($__vars['series'], 'canUseInlineModeration', array())) {
		$__finalCompiled .= '
