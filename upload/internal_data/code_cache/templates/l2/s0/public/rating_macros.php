...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	if (!$__templater->test($__vars['text'], 'empty', array())) {
		...
		$__finalCompiled .= '' . $__templater->filter($__vars['count'], array(array('number', array()),), true) . ' đánh giá';
	}
	$__finalCompiled .= '
		</span>
	</span>
...
'arguments' => function($__templater, array $__vars) { return array(
		...
		'deselectable' => 'false',
		'showSelected' => 'true',
		'range' => array(1 => 'Khủng khiếp', 2 => 'Nghèo nàn', 3 => 'Bình thường', 4 => 'Tốt', 5 => 'Tuyệt vời', ),
	); },
'code' => function($__templater, array $__vars, $__extensions = null)
{
	$__finalCompiled = '';
