...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	<script class="js-codeEditorLanguage" type="application/json">
		{
			"All": "' . $__templater->filter('Tất cả', array(array('escape', array('json', )),), true) . '",
			...
			"No": "' . $__templater->filter('Không', array(array('escape', array('json', )),), true) . '",
			...
			"Replace with:": "' . $__templater->filter('Thay thế bằng' . $__vars['xf']['language']['label_separator'], array(array('escape', array('json', )),), true) . '",
			"Replace:": "' . $__templater->filter('Thay thế' . $__vars['xf']['language']['label_separator'], array(array('escape', array('json', )),), true) . '",
			...
			"Search:": "' . $__templater->filter('Tìm kiếm' . $__vars['xf']['language']['label_separator'], array(array('escape', array('json', )),), true) . '",
			...
			"Yes": "' . $__templater->filter('Có', array(array('escape', array('json', )),), true) . '"
		}
	</script>
	';
