...
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Số liệu thống kê');
	$__finalCompiled .= '
	...
	if ($__vars['grouping'] != 'daily') {
		$__finalCompiled .= '
				<div class="block-row block-row--minor">
					' . 'Giá trị thể hiện mức trung bình hàng ngày trong mỗi khoảng thời gian.' . '
				</div>
			';
	}
	$__finalCompiled .= '
