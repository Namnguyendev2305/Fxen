<?php
// FROM HASH: fa96553884e8c6a9271dbbef6e137b98
return array(
...
' . $__templater->formNumberBoxRow(array(
		'name' => 'options[article_count]',
		'value' => $__vars['options']['article_count'],
		'min' => '0',
	), array(
		'label' => 'Minimum series article count',
		'explain' => 'The minimum required series articles.  <b>Note:</b> set to 0 to disable this option. ',
	)) . '
