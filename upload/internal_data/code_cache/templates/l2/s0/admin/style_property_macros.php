<?php
// FROM HASH: 8e7bdcd86d4539c88980524150f659ae
return array(
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	';
	$__vars['titleHtml'] = $__templater->preEscaped('<span class="u-anchorTarget" id="sp-' . $__templater->escape($__vars['property']['property_name']) . '"></span>' . $__templater->func('uix_style_property_prefix', array($__vars['property'], ), true) . $__templater->escape($__vars['property']['title']));
	$__finalCompiled .= '
	...
	if ($__vars['property']['property_type'] !== 'css') {
		$__compilerTemp1 .= '
			' . $__templater->func('uix_style_property_documentation', array($__vars['property'], ), true) . '
		';
	}
	$__compilerTemp2 = '';
	if ($__vars['xf']['development']) {
		$__compilerTemp2 .= $__templater->escape($__vars['property']['property_name']) . ' ' . $__templater->filter($__vars['property']['display_order'], array(array('parens', array()),), true);
	}
	$__compilerTemp3 = '';
	if ($__vars['definitionEditable']) {
		$__compilerTemp3 .= '
			<a href="' . $__templater->func('link', array('style-properties/edit', $__vars['property'], ), true) . '">' . 'Chỉnh sửa' . '</a>
		';
	}
	$__compilerTemp4 = '';
	...
	';
		...
		';
		if ($__templater->func('thuix_uploadable_style_property', array($__vars['property'], ), false) AND $__templater->method($__vars['xf']['visitor'], 'hasAdminPermission', array('uploadSPImages', ))) {
			$__finalCompiled .= '
	' . $__templater->includeTemplate('th_uix_uploadable_style_property', $__vars) . '
	';
		} else {
			$__finalCompiled .= '
	' . $__templater->formTextBoxRow(array(
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	<div class="cssPropertyWrapper" data-toggle-wrapper="1">
		...
		'property' => $__vars['property'],
				...
				<span class="u-anchorTarget" id="sp-' . $__templater->escape($__vars['property']['property_name']) . '"></span><span>' . $__templater->func('uix_style_property_prefix', array($__vars['property'], ), true) . $__templater->escape($__vars['property']['title']) . '</span>
				';
	...
	if ($__templater->method($__vars['property'], 'isValidCssComponent', array('text', ))) {
		$__finalCompiled .= '
						<li>
							<h4 class="cssPropertyHeader">' . 'Ký tự' . '</h4>
	...
	if ($__templater->method($__vars['property'], 'isValidCssComponent', array('background', ))) {
		$__finalCompiled .= '
						<li>
							<h4 class="cssPropertyHeader">' . 'Hình nền' . '</h4>
							<table class="cssPropertySet">
							<tr class="cssPropertySet-headerRow">
								<th>' . 'Màu sắc' . '</th>
							</tr>
	...
	if ($__templater->method($__vars['property'], 'isValidCssComponent', array('border', )) OR $__templater->method($__vars['property'], 'isValidCssComponent', array('border_radius', ))) {
		...
		$__finalCompiled .= '
							...
							<tr>
								<td class="cssPropertySet-rowLabel">' . 'Tất cả' . '</td>
		...
		$__finalCompiled .= '
							...
							<tr>
								<td class="cssPropertySet-rowLabel">' . 'Dưới' . '</td>
		...
		$__finalCompiled .= '
							...
							<tr>
								<td class="cssPropertySet-rowLabel">' . 'Trái' . '</td>
	...
	if ($__templater->method($__vars['property'], 'isValidCssComponent', array('extra', ))) {
		$__finalCompiled .= '
						<li class="cssPropertyExtra">
							<h4 class="cssPropertyHeader">' . 'Thêm' . '</h4>
							<table class="cssPropertySet">
								<tr class="cssPropertySet-headerRow">
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	if ($__vars['state'] == 'custom') {
		...
		$__compilerTemp1 .= '
				...
				<span  data-xf-init="tooltip" title="' . $__templater->filter('Giá trị tùy chỉnh cho thuộc tính này được thừa hưởng từ kiểu cha', array(array('for_attr', array()),), true) . '">
					' . 'Giá trị kế thừa' . '</span>
