					...
					'html' => '
								<div class="menu" data-menu="menu" aria-hidden="true" data-menu-builder="dataList">
									<div class="menu-content">
										...
										<a href="' . $__templater->func('link', array('banning/ips/add', null, array('ip' => $__templater->filter($__vars['ip']['ip'], array(array('ip', array()),), false), ), ), true) . '" class="menu-linkRow" data-xf-click="overlay">' . 'Cấm' . '</a>
