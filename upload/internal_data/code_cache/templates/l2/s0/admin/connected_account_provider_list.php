...
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Nhà cung cấp tài khoản đã kết nối');
	$__finalCompiled .= '
...
<div class="block">
	...
	if (!$__templater->test($__vars['inactiveProviders'], 'empty', array())) {
		...
		$__finalCompiled .= $__templater->dataList('
			...
			'_type' => 'cell',
			'html' => 'Các nhà cung cấp không hoạt động',
		))) . '
					' . $__compilerTemp3 . '
				', array(
		)) . '
