<?php
// FROM HASH: 9fbc5b2199952399149492643ca5ed07
return array(
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	if ($__templater->method($__vars['memberStat'], 'isInsert', array())) {
		$__finalCompiled .= '
	';
		$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Thêm thống kê thành viên');
		$__finalCompiled .= '
';
	} else {
		$__finalCompiled .= '
...
';
	...
	<div class="block-container">
		...
		'label' => 'Tất cả thành viên hợp lệ',
		'_type' => 'option',
	),
	array(
		'value' => 'searcher',
...
<code>return [$user->user_id => \\XF::language()->numberFormat($value)];</code>',
		...
		'methodName' => 'visibility_method',
		'readOnly' => (!$__templater->method($__vars['memberStat'], 'canEdit', array())),
	), $__vars) . '
			', array(
		'rowtype' => 'input',
		'label' => 'Visibility callback',
		'explain' => 'You may optionally set a PHP callback here to ascertain if this member stat should be displayed.<br />
<br />
Callback arguments:
<ol>
	<li>
...
The callback should return either <code>true</code> or <code>false</code>, where <code>false</code> will prevent the member stat from displaying.',
	)) . '
