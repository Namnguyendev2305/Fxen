...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	if ($__templater->method($__vars['field'], 'isInsert', array())) {
		$__finalCompiled .= '
	';
		$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Thêm trường nội dung');
		$__finalCompiled .= '
';
	} else {
		$__finalCompiled .= '
	';
		$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Chỉnh sửa trường loại nội dung' . $__vars['xf']['language']['label_separator'] . ' ' . $__templater->escape($__vars['field']['content_type']));
		$__finalCompiled .= '
';
	}
	$__finalCompiled .= '
