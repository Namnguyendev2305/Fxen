...
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Cụm từ đã lỗi thời');
	$__finalCompiled .= '
								...
								'html' => '
										...
										<div class="dataList-subRow">
											<ul class="listInline listInline--bullet">
												<li>' . 'Phiên bản tùy chỉnh' . $__vars['xf']['language']['label_separator'] . ' ' . $__templater->escape($__vars['outdated']['phrase']['version_string']) . '</li>
...
';
		...
		$__finalCompiled .= '
	<div class="blockMessage">' . 'Không có cụm từ nào lỗi thời.' . '</div>
';
	}
