...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	$__finalCompiled .= $__templater->formRadioRow(array(
		...
		'label' => 'Không có điều khoản và nội quy',
		'_type' => 'option',
	),
	array(
		'value' => 'default',
		'selected' => $__vars['option']['option_value']['type'] == 'default',
		'label' => 'URL mặc định' . $__vars['xf']['language']['label_separator'] . ' ' . $__templater->func('link_type', array('public', 'canonical:help/terms', ), true),
		'_type' => 'option',
	),
	array(
		'value' => 'custom',
