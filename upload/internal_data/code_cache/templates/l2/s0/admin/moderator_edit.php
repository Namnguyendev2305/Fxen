...
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Chỉnh sửa kiểm duyệt viên' . $__vars['xf']['language']['label_separator'] . ' ' . $__templater->escape($__vars['user']['username']));
	$__finalCompiled .= '
...
';
	...
	<div class="block-container">
		...
		'rowid' => 'addUserGroups',
		'label' => 'Thêm Kiểm duyệt viên vào nhóm thành viên',
		'hint' => '
					' . $__templater->formCheckBox(array(
		'standalone' => 'true',
	), array(array(
