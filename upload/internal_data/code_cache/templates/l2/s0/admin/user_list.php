<?php
// FROM HASH: 8458784b468a04bbe0f1397d8198fbff
return array(
'code' => function($__templater, array $__vars, $__extensions = null)
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Thành viên');
	$__finalCompiled .= '
		...
		if (!$__vars['showingAll']) {
			...
			<div class="block-outer">
				<div class="block-outer-main">
					' . $__templater->button('
						' . 'Sắp xếp theo' . $__vars['xf']['language']['label_separator'] . ' ' . ($__templater->escape($__vars['sortOptions'][$__vars['order']]) ?: 'Tên thành viên') . '
					', array(
				...
				'aria-haspopup' => 'true',
					...
					<div class="menu" data-menu="menu" aria-hidden="true">
						<div class="menu-content">
							<h3 class="menu-header">' . 'Sắp xếp theo' . $__vars['xf']['language']['ellipsis'] . '</h3>
							';
