	...
	';
		...
		<div class="block-container">
			...
			<div class="block-footer">
				<span class="u-pullRight">' . 'Hiển thị ' . $__templater->func('count', array($__vars['style']->{'th_child_style_cache_uix'}, ), true) . ' trong số ' . $__templater->func('count', array($__vars['style']->{'th_child_style_cache_uix'}, ), true) . ' mục' . '</span>
			</div>
		</div>
	', array(
