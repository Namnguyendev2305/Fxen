...
';
	$__templater->breadcrumb($__templater->preEscaped($__templater->escape($__vars['style']['title']) . ' - ' . 'Thuộc tính giao diện'), $__templater->func('link', array('styles/style-properties', $__vars['style'], ), false), array(
	));
	$__finalCompiled .= '
