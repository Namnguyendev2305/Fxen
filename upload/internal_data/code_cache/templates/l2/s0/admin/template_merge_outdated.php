...
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Hợp nhất thay đổi mẫu' . $__vars['xf']['language']['label_separator'] . ' ' . $__templater->escape($__vars['template']['title']));
	$__finalCompiled .= '
...
', )),), false), array(
				...
				$__compilerTemp1 .= $__templater->func('trim', array('
								...
								<div class="diffList-resolve">
									...
									' . $__templater->button('
										&uarr; ' . 'Giải quyết bằng cách sử dụng phiên bản gốc' . '
									', array(
...
', )),), false), array(
	...
	<div class="block-container">
		<div class="block-body">
			...
			<div class="block-row block-row--separated">
				' . 'Bạn có thể nhấp vào bản cập nhật để chỉnh sửa nó.' . '
			</div>
		</div>
