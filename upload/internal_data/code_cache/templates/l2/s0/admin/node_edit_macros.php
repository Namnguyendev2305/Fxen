...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	' . $__templater->formTextBoxRow(array(
		...
		'label' => 'URL portion',
		'hint' => ($__vars['optional'] ? 'Tùy chọn (không bắt buộc)' : ''),
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	$__finalCompiled .= $__templater->formCheckBoxRow(array(
		...
		'explain' => 'Nếu được chỉ định, tất cả khách truy cập sẽ xem mục này và nội dung của nó bằng cách sử dụng kiểu đã chọn, bất kể sở thích kiểu cá nhân của họ.',
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	$__compilerTemp1 = array(array(
		'value' => '',
		'label' => ('Mặc định' . ($__vars['defaultNav'] ? ((' (' . $__templater->escape($__vars['defaultNav']['title'])) . ')') : '')),
		'_type' => 'option',
	));
	...
	$__finalCompiled .= $__templater->formSelectRow(array(
		...
		'explain' => 'Điều này điều khiển phần điều hướng sẽ được chọn khi khách truy cập chuyên mục này. Các chuyên mục con sẽ tự động kế thừa giá trị này.',
	)) . '
';
	return $__finalCompiled;
}
