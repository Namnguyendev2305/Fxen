...
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Tùy chỉnh giao diện' . $__vars['xf']['language']['label_separator'] . ' ' . $__templater->escape($__vars['style']['title']));
	$__finalCompiled .= '
	...
	<div class="block">
		...
		<div class="block-container">
			<div class="block-body block-row">
				' . 'Giao diện này không chứa mẫu tùy chỉnh hoặc thuộc tính giao diện.' . '
			</div>
		</div>
	</div>
';
