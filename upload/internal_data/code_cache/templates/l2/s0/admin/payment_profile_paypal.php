...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	$__finalCompiled .= $__templater->formTextBoxRow(array(
		...
		'hint' => '(Yêu cầu)',
		'explain' => '
		' . 'Đây là địa chỉ email chính trên tài khoản PayPal của bạn. Nếu không chính xác, thanh toán có thể không được xử lý thành công. Lưu ý đây phải là tài khoản Premier hoặc Business của PayPal và phải bật IPNs.' . '
	',
	)) . '
...
' . $__templater->formCheckBoxRow(array(
		...
		'hint' => 'Nếu được bật, nhà cung cấp dịch vụ thanh toán sẽ thu thập địa chỉ người nhận thanh toán trong khi thanh toán.',
		'_type' => 'option',
	)), array(
	)) . '
