<?php
// FROM HASH: 3bbf4b1d26a2e3c2531dfa482e40dd09
return array(
					...
					'html' => '
									...
									<div class="menu" data-menu="menu" aria-hidden="true">
										<div class="menu-content">
											...
											<a href="' . $__templater->func('link', array($__vars['linkPrefix'] . '/add', null, array($__vars['parentIdKey'] => $__vars['category'][$__vars['parentIdKey']], ), ), true) . '" class="menu-linkRow">' . 'Ngang hàng' . '</a>
											...
											<a href="' . $__templater->func('link', array($__vars['linkPrefix'] . '/add', null, array($__vars['parentIdKey'] => $__vars['category'][$__vars['idKey']], ), ), true) . '" class="menu-linkRow">' . 'Con' . '</a>
...
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Article categories');
	$__finalCompiled .= '
