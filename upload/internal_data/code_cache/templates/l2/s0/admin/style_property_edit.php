...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	if ($__templater->method($__vars['property'], 'isInsert', array())) {
		$__finalCompiled .= '
	';
		$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Thêm thuộc tính');
		$__finalCompiled .= '
';
	} else {
		$__finalCompiled .= '
...
';
	...
	array(
		...
		'label' => 'Giá trị nhóm',
		'explain' => 'Khi được liệt kê, nếu thuộc tính này không có cùng giá trị nhóm như thuộc tính trước đó, một dấu phân tách sẽ được chèn.',
	)) . '
			</div>
