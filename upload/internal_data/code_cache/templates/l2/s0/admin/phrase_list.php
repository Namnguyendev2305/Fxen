		...
		';
			...
			if ($__vars['phrase']['language_id'] == $__vars['language']['language_id']) {
				$__compilerTemp1[] = array(
					...
					'tooltip' => ($__vars['phrase']['language_id'] ? 'Khôi phục' : 'Xóa'),
					'_type' => 'delete',
					'html' => '',
				);
			}
...
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped($__templater->escape($__vars['language']['title']) . ' - ' . 'Cụm từ');
	$__finalCompiled .= '
