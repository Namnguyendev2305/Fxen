...
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Nhật ký oEmbed');
	$__finalCompiled .= '
...
';
	...
	<div class="block-container">
		<div class="block-body block-row">
			<span>
				<label>' . 'Nhà cung cấp dịch vụ là' . $__vars['xf']['language']['label_separator'] . '
		...
		'class' => 'input--inline',
			...
			<span>
				<label>' . 'Sắp xếp theo' . $__vars['xf']['language']['label_separator'] . '
				' . $__templater->formSelect(array(
		'name' => 'order',
