...
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Nhập giao diện');
	$__finalCompiled .= '
...
';
	...
	<div class="block-container">
		...
		'value' => 'new',
		'checked' => 'checked',
		'label' => 'Con của giao diện' . $__vars['xf']['language']['label_separator'],
	...
	array(
		'value' => 'overwrite',
		'label' => 'Ghi đè giao diện',
		'_dependent' => array($__templater->formSelect(array(
		'name' => 'overwrite_style_id',
	), $__compilerTemp4)),
		'_type' => 'option',
	)), array(
		'label' => 'Nhập dưới dạng',
	)) . '
