	...
	if ($__vars['asArchive']) {
		$__compilerTemp1 .= '
				' . $__templater->formInfoRow('
					<div class="blockMessage blockMessage--important"><strong>' . 'Chú ý' . $__vars['xf']['language']['label_separator'] . '</strong> ' . 'Style archives may only contain files with the following extensions: ' . $__templater->filter($__vars['allowedExtensions'], array(array('join', array(', ', )),), true) . '.' . '</div>
				', array(
		)) . '
			';
	}
