...
';
	if ($__vars['review']['is_anonymous']) {
		$__finalCompiled .= '
	' . '<p>' . 'Vô danh' . ' posted a review on an article you are watching at ' . (((('<a href="' . $__templater->func('link', array('canonical:index', ), true)) . '">') . $__templater->escape($__vars['xf']['options']['boardTitle'])) . '</a>') . '.</p>' . '	
';
	} else {
		$__finalCompiled .= '
