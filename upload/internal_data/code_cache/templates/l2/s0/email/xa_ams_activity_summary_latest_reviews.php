	...
	';
		...
		';
			...
			';
					...
					$__compilerTemp1 .= '
				' . ($__templater->escape($__vars['review']['User']['username']) ?: 'Thành viên đã bị xoá') . '
			';
				}
		...
		';
				...
				if ($__vars['review']['reaction_score']) {
					$__compilerTemp2 .= '
				&middot; ' . 'Điểm tương tác' . $__vars['xf']['language']['label_separator'] . ' ' . $__templater->filter($__vars['review']['reaction_score'], array(array('number_short', array()),), true) . '
			';
				}
		...
		';
			...
			<div style="padding: 5px 0;">
				<span style="font-weight:700;">' . 'Bình chọn' . $__vars['xf']['language']['label_separator'] . '</span>
