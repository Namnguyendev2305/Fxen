<?php
// FROM HASH: ab71d7db7864ad74d828d75b16c08d5b
return array(
...
';
	$__templater->includeCss('xa_ams_map_marker_legend.less');
	$__finalCompiled .= '
...
<div class="block">
	...
	if ($__vars['category']['map_options']['custom_featured_map_marker_url']) {
		...
		$__compilerTemp1 .= '
							<img src="' . $__templater->func('base_url', array($__vars['xf']['options']['xaAmsDefaultFeaturedMapMarkerIconUrl'], ), true) . '" />
						';
	}
	$__compilerTemp2 = '';
	if ($__vars['category']['map_options']['custom_map_marker_url']) {
		...
		$__compilerTemp2 .= '
							<img src="' . $__templater->func('base_url', array($__vars['xf']['options']['xaAmsDefaultMapMarkerIconUrl'], ), true) . '" />
						';
	}
	$__compilerTemp3 = '';
