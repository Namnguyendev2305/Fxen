...
';
	...
	if (!$__templater->test($__vars['availableFields'], 'empty', array())) {
		...
		$__compilerTemp6 .= '
				...
				' . $__templater->formRow('
					' . $__templater->filter('None', array(array('parens', array()),), true) . ' <a href="' . $__templater->func('link', array('xa-ams/article-fields', ), true) . '" target="_blank">' . 'Add field' . '</a>
				', array(
			'label' => 'Available fields',
		)) . '
			';
	...
	if (!$__templater->test($__vars['availableReviewFields'], 'empty', array())) {
		...
		$__compilerTemp8 .= '
				...
				' . $__templater->formRow('
					' . $__templater->filter('None', array(array('parens', array()),), true) . ' <a href="' . $__templater->func('link', array('xa-ams/review-fields', ), true) . '" target="_blank">' . 'Add field' . '</a>
				', array(
			'label' => 'Available fields',
		)) . '
			';
	...
	if (!$__templater->test($__vars['availablePrefixes'], 'empty', array())) {
		...
		$__compilerTemp10 .= '
				...
				' . $__templater->formRow('
					' . $__templater->filter('None', array(array('parens', array()),), true) . ' <a href="' . $__templater->func('link', array('xa-ams/prefixes', ), true) . '" target="_blank">' . 'Add prefix' . '</a>
				', array(
			'label' => 'Available prefixes',
		)) . '
	...
	if (!$__templater->test($__vars['availablePrompts'], 'empty', array())) {
		...
		$__compilerTemp14 .= '
				...
				' . $__templater->formRow('
					' . $__templater->filter('None', array(array('parens', array()),), true) . ' <a href="' . $__templater->func('link', array('xa-ams/prompts', ), true) . '" target="_blank">' . 'Add prompt' . '</a>
				', array(
			'label' => 'Available prompts',
		)) . '
