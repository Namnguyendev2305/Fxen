<?php
// FROM HASH: a6a6f40f3d0ef167e062f0b62b6f8eed
return array(
...
';
	...
	$__finalCompiled .= $__templater->formCheckBoxRow(array(
		...
		'label' => 'Article author in user groups',
		'explain' => 'True if the article author is in one or more of the selected groups.',
	)) . '
...
';
	...
	$__finalCompiled .= $__templater->formCheckBoxRow(array(
		...
		'label' => 'Article author not in user groups',
		'explain' => 'True if the article author is not in any of the selected groups.',
	)) . '
...
' . $__templater->formRow('
	<div class="inputGroup">
		...
		'name' => 'criteria[publish_date][start]',
		'value' => $__vars['criteria']['publish_date']['start'],
		'size' => '15',
	)) . '
		<span class="inputGroup-text">-</span>
		' . $__templater->formDateInput(array(
		'name' => 'criteria[publish_date][end]',
		'value' => $__vars['criteria']['publish_date']['end'],
		'size' => '15',
	)) . '
	</div>
', array(
...
' . $__templater->formRow('
	...
	<div class="inputGroup">
		' . $__templater->formNumberBox(array(
		'name' => 'criteria[page_count][start]',
		'value' => $__vars['criteria']['page_count']['start'],
		'size' => '5',
		'min' => '0',
	)) . '
		<span class="inputGroup-text">-</span>
		' . $__templater->formNumberBox(array(
		'name' => 'criteria[page_count][end]',
		'value' => $__vars['criteria']['page_count']['end'],
		'size' => '5',
		'min' => '-1',
	)) . '
	</div>
...
' . $__templater->formCheckBoxRow(array(
		'name' => 'criteria[article_state]',
	), array(array(
		'value' => 'visible',
		'selected' => $__templater->func('in_array', array('visible', $__vars['criteria']['article_state'], ), false),
		'label' => 'Visible',
		'_type' => 'option',
	),
	array(
		'value' => 'deleted',
		'selected' => $__templater->func('in_array', array('deleted', $__vars['criteria']['article_state'], ), false),
		'label' => 'Deleted',
		'_type' => 'option',
	),
	array(
		'value' => 'moderated',
		'selected' => $__templater->func('in_array', array('moderated', $__vars['criteria']['article_state'], ), false),
		'label' => 'Moderated',
		'_type' => 'option',
	),
	array(
		'value' => 'draft',
		'selected' => $__templater->func('in_array', array('draft', $__vars['criteria']['article_state'], ), false),
		'label' => 'Draft',
		'_type' => 'option',
	),
	array(
		'value' => 'awaiting',
		'selected' => $__templater->func('in_array', array('awaiting', $__vars['criteria']['article_state'], ), false),
...
';
	...
	$__compilerTemp4 .= '
		';
	$__compilerTemp5 = $__templater->method($__templater->method($__vars['xf']['app']['em'], 'getRepository', array('XenAddons\\AMS:ArticleField', )), 'getDisplayGroups', array());
	if ($__templater->isTraversable($__compilerTemp5)) {
		foreach ($__compilerTemp5 AS $__vars['fieldGroup'] => $__vars['phrase']) {
			$__compilerTemp4 .= '
			';
			$__vars['customFields'] = $__templater->method($__vars['xf']['app'], 'getCustomFields', array('ams_articles', $__vars['fieldGroup'], ));
			$__compilerTemp4 .= '
			';
			$__compilerTemp6 = '';
			$__compilerTemp6 .= '
			...
			if ($__templater->isTraversable($__vars['customFields'])) {
				foreach ($__vars['customFields'] AS $__vars['fieldId'] => $__vars['fieldDefinition']) {
					...
					$__compilerTemp6 .= '
						';
					$__vars['fieldName'] = 'criteria[article_field]' . ((($__vars['choices'] AND ($__vars['fieldDefinition']['type_group'] != 'multiple'))) ? '[exact]' : '') . '[' . $__vars['fieldId'] . ']';
					$__compilerTemp6 .= '
						';
					$__compilerTemp7 = '';
					if (!$__vars['choices']) {
