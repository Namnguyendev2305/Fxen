<?php
// FROM HASH: e923a012d61211ec1aad817373e88483
return array(
	...
	if ($__vars['findNew']['result_count']) {
		...
		if ($__templater->isTraversable($__vars['items'])) {
			foreach ($__vars['items'] AS $__vars['item']) {
				$__finalCompiled .= '
				' . $__templater->callMacro('xa_ams_article_list_macros', 'article_list_item_struct_item', array(
					'item' => $__vars['item'],
				), $__vars) . '
			';
			}
...
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('New article comments');
	$__templater->pageParams['pageNumber'] = $__vars['page'];
	$__finalCompiled .= '

';
	$__compilerTemp1 = $__vars;
	$__compilerTemp1['pageSelected'] = $__templater->preEscaped('ams_new_comment');
...
<div class="block">
	...
	<div class="block-container">
		...
		'findNew' => $__vars['findNew'],
		'rerunRoute' => 'whats-new/ams-comments',
		'rerunData' => $__vars['findNew'],
		'filterRoute' => 'whats-new/ams-comments',
	), $__vars) . '

		' . $__templater->callMacro(null, 'results', array(
		'findNew' => $__vars['findNew'],
		'items' => $__vars['items'],
		'latestRoute' => 'whats-new/ams-comments',
	), $__vars) . '
	</div>
