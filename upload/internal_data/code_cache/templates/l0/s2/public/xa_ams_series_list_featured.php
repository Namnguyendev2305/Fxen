<?php
// FROM HASH: 3b1f336878f48dedff5558f062a08f57
return array(
...
';
	$__templater->breadcrumb($__templater->preEscaped('Series list'), $__templater->func('link', array('ams/series', ), false), array(
	));
	$__finalCompiled .= '
...
<div class="block" data-xf-init="' . ($__vars['canInlineMod'] ? 'inline-mod' : '') . '" data-type="ams_series" data-href="' . $__templater->func('link', array('inline-mod', ), true) . '">
	...
	if (!$__templater->test($__vars['series'], 'empty', array())) {
		...
		$__finalCompiled .= '
				<div class="block-row">' . 'xa_ams_no_series_have_been_featured_yet' . '</div>
			';
	}
	$__finalCompiled .= '
		</div>
