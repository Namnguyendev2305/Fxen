<?php
// FROM HASH: 311d6c14ea089510b2a7580122778798
return array(
'code' => function($__templater, array $__vars, $__extensions = null)
{
	$__finalCompiled = '';
	$__finalCompiled .= '<mail:subject>
	' . 'New article on watched series' . '
</mail:subject>

' . '<p>' . $__templater->func('username_link_email', array($__vars['article']['User'], $__vars['article']['username'], ), true) . ' added an article to a series you are watching at ' . (((('<a href="' . $__templater->func('link', array('canonical:index', ), true)) . '">') . $__templater->escape($__vars['xf']['options']['boardTitle'])) . '</a>') . '.</p>' . '
...
' . $__templater->callMacro('xa_ams_article_macros', 'watched_series_footer', array(
