...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	';
		if ($__vars['content']['is_anonymous']) {
			$__finalCompiled .= '
		' . '' . 'Anonymous' . ' reviewed the article ' . ((((('<a href="' . $__templater->func('link', array('ams/review', $__vars['content'], ), true)) . '" class="fauxBlockLink-blockLink">') . $__templater->func('prefix', array('ams_article', $__vars['content']['Article'], ), true)) . $__templater->escape($__vars['content']['Article']['title'])) . '</a>') . '.' . '
	';
		} else {
			$__finalCompiled .= '
...
';
	...
	';
		if ($__vars['content']['is_anonymous']) {
			$__finalCompiled .= '	
		' . '' . 'Anonymous' . ' rated the article ' . ((((('<a href="' . $__templater->func('link', array('ams', $__vars['content']['Article'], ), true)) . '" class="fauxBlockLink-blockLink">') . $__templater->func('prefix', array('ams_article', $__vars['content']['Article'], ), true)) . $__templater->escape($__vars['content']['Article']['title'])) . '</a>') . '.' . '
	';
		} else {
			$__finalCompiled .= '
