<?php
// FROM HASH: 4fbf82d411aaa670133ff1f996aba167
return array(
...
';
	...
	if ($__templater->isTraversable($__vars['seriesItems'])) {
		foreach ($__vars['seriesItems'] AS $__vars['seriesItem']) {
			$__compilerTemp1 .= '
		' . $__templater->formHiddenVal('ids[]', $__vars['seriesItem']['series_id'], array(
			)) . '
	';
		}
	}
	...
	<div class="block-container">
		<div class="block-body">
			' . $__templater->formInfoRow('Are you sure you want to delete ' . $__templater->escape($__vars['total']) . ' series?', array(
		'rowtype' => 'confirm',
	)) . '
	...
	' . $__templater->formHiddenVal('type', 'ams_series', array(
	)) . '
