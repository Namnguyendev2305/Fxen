...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	if ($__vars['review']['user_id'] == $__vars['xf']['visitor']['user_id']) {
		...
		$__finalCompiled .= '
			' . '' . $__templater->func('username_link', array($__vars['reactionUser'], false, array('defaultname' => $__vars['fallbackName'], ), ), true) . ' reacted to ' . ($__vars['review']['is_anonymous'] ? 'Anonymous' : $__templater->escape($__vars['review']['username'])) . '\'s review on article ' . (((('<a href="' . $__templater->func('link', array('ams/review', $__vars['review'], ), true)) . '" class="fauxBlockLink-blockLink">') . $__templater->escape($__vars['review']['Content']['title'])) . '</a>') . ' with ' . $__templater->filter($__templater->func('alert_reaction', array($__vars['reactionId'], 'medium', ), false), array(array('preescaped', array()),), true) . '.' . '
		';
	}
	$__finalCompiled .= '
	</div>
