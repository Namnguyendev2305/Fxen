...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	if ($__templater->method($__vars['feed'], 'isInsert', array())) {
		$__finalCompiled .= '
	';
		$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Thêm nguồn cấp dữ liệu');
		$__finalCompiled .= '
';
	} else {
		$__finalCompiled .= '
...
<br />{title} {description} {content} {author} {link}',
	...
	array(
		...
		'label' => 'Ghim lại',
		'hint' => 'Chủ đề ghim xuất hiện trên đầu của trang đầu tiên của danh sách các chủ đề trong diễn đàn.',
		'_type' => 'option',
	)), array(
		'label' => 'Tùy chọn',
	)) . '
