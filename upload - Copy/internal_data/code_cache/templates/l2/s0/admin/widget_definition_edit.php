...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	if ($__templater->method($__vars['widgetDefinition'], 'isInsert', array())) {
		$__finalCompiled .= '
	';
		$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Thêm loại widget');
		$__finalCompiled .= '
';
	} else {
		$__finalCompiled .= '
	';
		$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Sửa loại widget' . $__vars['xf']['language']['label_separator'] . ' ' . $__templater->escape($__vars['widgetDefinition']['title']));
		$__finalCompiled .= '
';
	}
	$__finalCompiled .= '
