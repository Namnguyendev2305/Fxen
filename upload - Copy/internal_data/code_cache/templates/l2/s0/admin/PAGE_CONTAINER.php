<?php
// FROM HASH: 349cfb4b5b1abd8ceacd08b2ff221a53
return array(
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	<div class="menu menu--structural" data-menu="menu" aria-hidden="true">
		<div class="menu-content js-optionGroupsMenuBody">
			...
			<h4 class="menu-header menu-header--small">' . 'Hình thức' . '</h4>
			...
			<h4 class="menu-header menu-header--small">' . 'Mã' . '</h4>
...
<head>
	...
	<title>
		' . $__templater->func('page_title', array('%s | ' . $__vars['xf']['options']['boardTitle'] . ' - ' . 'Bảng điều khiển Quản trị viên', $__vars['xf']['options']['boardTitle'] . ' - ' . 'Bảng điều khiển Quản trị viên', null)) . '
	</title>
...
<header class="p-header">
	<div class="p-header-buttons p-header-buttons--main">
		...
		<a href="' . $__templater->func('link', array('index', ), true) . '" class="p-header-button" aria-label="' . $__templater->filter('Trang chủ', array(array('for_attr', array()),), true) . '">' . $__templater->fontAwesome('fa-home', array(
	)) . '</a>
	...
	if ($__templater->method($__vars['xf']['visitor'], 'hasAdminPermission', array('option', ))) {
		$__finalCompiled .= '
			<a class="p-header-button" data-xf-key="' . $__templater->filter('o', array(array('for_attr', array()),), true) . '" data-xf-click="menu" role="button" tabindex="0"
				aria-label="' . $__templater->filter('Tùy chọn', array(array('for_attr', array()),), true) . '"
				aria-expanded="false"
				aria-haspopup="true">
	...
	$__finalCompiled .= '
		...
		<form action="' . $__templater->func('link', array('search/search', ), true) . '" class="menu menu--structural menu--veryWide" data-xf-init="admin-search" data-menu="menu" aria-hidden="true">
			<div class="menu-content">
				<h3 class="menu-header">' . 'Tìm kiếm' . $__vars['xf']['language']['ellipsis'] . '</h3>
				<div class="menu-row">
...
<footer class="p-footer">
	<div class="p-footer-row">
		<div class="p-footer-row-main">
			<a href="' . $__templater->func('link', array('login/logout', null, array('t' => $__templater->func('csrf_token', array(), false), ), ), true) . '">' . 'Thoát' . '</a>
		</div>
	...
	if ($__templater->method($__vars['xf']['visitor'], 'canChangeLanguage', array())) {
		$__finalCompiled .= '
				<a href="' . $__templater->func('link', array('account/language', ), true) . '" data-xf-click="overlay" data-xf-init="tooltip" title="' . $__templater->filter('Chọn ngôn ngữ', array(array('for_attr', array()),), true) . '">
