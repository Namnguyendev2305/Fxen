...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	$__vars['tabs'] = $__templater->preEscaped('
		<a class="tabs-tab' . (($__vars['active'] == 'user') ? ' is-active' : '') . '"
			...
			' . ($__vars['userTabTitle'] ? $__templater->escape($__vars['userTabTitle']) : 'Tiêu chí thành viên') . '</a>
...
',
	...
	array(
		...
		'label' => 'User has solved at least X questions' . $__vars['xf']['language']['label_separator'],
		'_dependent' => array($__templater->formNumberBox(array(
	...
	array(
		...
		'label' => 'User has solved no more than X questions' . $__vars['xf']['language']['label_separator'],
		'_dependent' => array($__templater->formNumberBox(array(
	...
	array(
		...
		'afterhint' => 'If you would like to match specific users, you may enter their usernames here, separated by commas.',
		'_type' => 'option',
	),
	array(
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	$__vars['panes'] = $__templater->preEscaped('
		...
		'hint' => 'This criteria is deprecated and will be removed from a future version. It may not work as anticipated when using the advanced cookie consent feature.',
		'_type' => 'option',
	)), array(
	)) . '
	...
	array(
		...
		'afterhint' => 'You may specify the action name as <b>account-details</b> or <b>AccountDetails</b>, but do not include <b>action</b> as a prefix. The action name is matched case insensitively. You may leave the action blank to apply to all actions within the specified controller.',
		'_type' => 'option',
	),
	array(
	...
	array(
		...
		'label' => 'Mẫu nội dung là' . $__vars['xf']['language']['label_separator'],
		'_dependent' => array($__templater->formTextBox(array(
