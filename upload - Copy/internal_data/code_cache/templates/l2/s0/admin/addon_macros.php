...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	<a class="' . $__templater->escape($__vars['linkClass']) . ' menuTrigger"
		...
		tabindex="0"
		aria-expanded="false"
		aria-haspopup="true">' . 'Tiện ích' . $__vars['xf']['language']['label_separator'] . ' ' . ($__vars['currentAddOn'] ? $__templater->escape($__vars['currentAddOn']['title']) : $__vars['xf']['language']['parenthesis_open'] . 'Tất cả' . $__vars['xf']['language']['parenthesis_close']) . '</a>

	<div class="menu" data-menu="menu" aria-hidden="true">
		<div class="menu-content">
			<h3 class="menu-header">' . 'Tiện ích' . '</h3>
