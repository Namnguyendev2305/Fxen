<?php
// FROM HASH: ceadf091fda286587c57de6ec004aa6e
return array(
'code' => function($__templater, array $__vars, $__extensions = null)
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Chỉnh sửa mẫu');
	$__finalCompiled .= '
...
';
	...
	if ($__vars['groupedModifications']) {
				...
				if ($__templater->isTraversable($__vars['modifications'])) {
					foreach ($__vars['modifications'] AS $__vars['modification']) {
						$__compilerTemp3 .= '
							...
							'submit' => 'true',
							'tooltip' => 'Bật / Tắt \'' . $__vars['modification']['modification_key'] . '\'',
							'_type' => 'toggle',
							'html' => '',
						),
						array(
		...
		$__compilerTemp2 .= '
			<div class="block-body block-row">' . 'Chưa có chỉnh sửa mẫu nào được xác định.' . '</div>
		';
	}
