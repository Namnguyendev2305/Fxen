...
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Dịch cụm từ' . $__vars['xf']['language']['label_separator'] . ' ' . $__templater->escape($__vars['language']['title']));
	$__finalCompiled .= '
		...
		'aria-haspopup' => 'true',
				...
				<div class="menu menu--wide" data-menu="menu" aria-hidden="true"
					...
					<div class="menu-content">
						<h4 class="menu-header">' . 'Tinh chỉnh tìm kiếm' . '</h4>
