	...
	if ($__vars['depth'] == 1) {
		...
		if ($__vars['navigation']['navigation_id'] == $__vars['xf']['app']['defaultNavigationId']) {
			...
			$__compilerTemp1[] = array(
				...
				'submit' => 'true',
				'tooltip' => 'Bật / Tắt \'' . $__vars['navigation']['title'] . '\'',
				'_type' => 'toggle',
				'html' => '',
			);
			$__compilerTemp1[] = array(
...
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Điều hướng công khai');
	$__finalCompiled .= '

';
	$__templater->pageParams['pageAction'] = $__templater->preEscaped('
	<div class="buttonGroup">
		' . $__templater->button('Thêm thanh điều hướng', array(
