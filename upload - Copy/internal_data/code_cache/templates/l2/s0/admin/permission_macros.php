<?php
// FROM HASH: 684669059a4dc70692a457124536edce
return array(
'macros' => array('edit_outer' => array(
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	<div class="' . $__templater->escape($__vars['class']) . '"
		data-xf-init="permission-form"
		data-form="< form"
		data-permission-type="' . $__templater->escape($__vars['type']) . '">

		<div class="' . $__templater->escape($__vars['class']) . '-main js-globalPermissionQuickSet">
			' . $__templater->button('Thiết lập nhanh', array(
		...
		<div class="' . $__templater->escape($__vars['class']) . '-opposite quickFilter">
			<input type="text" class="input js-permissionFilterInput" placeholder="' . 'Lọc' . $__vars['xf']['language']['ellipsis'] . '" />
		</div>
	</div>
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	<div class="menu" data-menu="menu" aria-hidden="true">
		<div class="menu-content">
			<h3 class="menu-header">' . 'Thiết lập nhanh' . '</h3>
			';
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	if ($__vars['permission']['permission_type'] == 'flag') {
		...
		$__compilerTemp1 .= '
			...
			'data-container' => '< li',
			'label' => 'Như theo dõi' . $__vars['xf']['language']['label_separator'],
			'hiddenlabel' => 'true',
