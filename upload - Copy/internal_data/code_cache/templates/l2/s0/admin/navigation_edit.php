...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	if ($__templater->method($__vars['navigation'], 'isInsert', array())) {
		$__finalCompiled .= '
	';
		$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Thêm thanh điều hướng');
		$__finalCompiled .= '
';
	} else {
		$__finalCompiled .= '
...
';
	...
	<div class="blockMessage blockMessage--warning">
		' . 'Tùy chỉnh của thành viên cho mục nhập chuyển hướng này sẽ được duy trì thông qua các nâng cấp bổ sung.' . '
	</div>
';
	}
	$__finalCompiled .= '
