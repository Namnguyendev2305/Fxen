...
return array(
'macros' => array('language_change_menu' => array(
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	<a class="' . $__templater->escape($__vars['linkClass']) . ' menuTrigger"
		...
		tabindex="0"
		aria-expanded="false"
		aria-haspopup="true">' . 'Ngôn ngữ' . $__vars['xf']['language']['label_separator'] . ' ' . $__templater->escape($__vars['currentLanguage']['title']) . '</a>

	<div class="menu" data-menu="menu" aria-hidden="true">
		<div class="menu-content">
			<h3 class="menu-header">' . 'Ngôn ngữ' . '</h3>
			';
