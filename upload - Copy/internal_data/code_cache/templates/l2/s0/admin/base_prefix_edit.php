...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	if ($__templater->method($__vars['prefix'], 'isInsert', array())) {
		$__finalCompiled .= '
	';
		$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Thêm tiền tố');
		$__finalCompiled .= '
';
	} else {
		$__finalCompiled .= '
	';
		$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Sửa tiền tố' . $__vars['xf']['language']['label_separator'] . ' ' . $__templater->escape($__vars['prefix']['title']));
		$__finalCompiled .= '
';
	}
	$__finalCompiled .= '
