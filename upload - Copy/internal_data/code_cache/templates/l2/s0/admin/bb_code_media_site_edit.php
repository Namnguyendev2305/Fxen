...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	if ($__templater->method($__vars['site'], 'isInsert', array())) {
		$__finalCompiled .= '
	';
		$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Thêm BB Code Media Site');
		$__finalCompiled .= '
';
	} else {
		$__finalCompiled .= '
...
<code>public static function myCallback($mediaKey, array $site, $siteId)</code>',
		...
		'label' => 'Cookie third parties',
		'explain' => 'Enter the identifier of each third party which sets cookies for this media site. Place each identifier on a separate line.',
	)) . '
		</div>
