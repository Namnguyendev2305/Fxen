	...
	<div class="block-container">
		<div class="block-body">
			' . $__templater->formInfoRow('
				...
				<strong><a href="' . $__templater->escape($__vars['xf']['privacyPolicyUrl']) . '" target="_blank">' . 'Chính sách bảo mật' . ' &middot; ' . 'Cập nhật mới nhất' . $__vars['xf']['language']['label_separator'] . ' ' . $__compilerTemp1 . '</a></strong>
			', array(
		'rowtype' => 'confirm',
	)) . '
		</div>
