...
';
	...
	';
		...
		$__compilerTemp1 .= '
		' . 'Step ' . $__templater->escape($__vars['importCompletion']['current']) . ' of ' . $__templater->escape($__vars['importCompletion']['total']) . '' . $__vars['xf']['language']['label_separator'] . ' ' . 'Đang thực hiện' . $__vars['xf']['language']['ellipsis'] . '
	';
	} else {
		$__compilerTemp1 .= '
		' . 'Đang thực hiện' . $__vars['xf']['language']['ellipsis'] . '
	';
	}
