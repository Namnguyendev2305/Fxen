...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	$__finalCompiled .= $__templater->formCheckBoxRow(array(
		...
		'data-hide' => 'true',
		'hint' => 'StopForumSpam will test the data collected from registering users and attempt to determine if they are a known spammer. Each warning flag that the user generates will be counted. Flags include username, email and IP address.',
	...
	array(
		...
		'units' => 'Days',
					...
					<p class="formRow-explain">' . 'Để tránh sai tích cực, bạn có thể lựa chọn chỉ đếm số truy cập đối với cơ sở dữ liệu thư rác đã được ghi lại trước đó trong một khoảng thời gian giới hạn.' . '</p>
				'),
		'_type' => 'option',
	),
	array(
		...
		'value' => $__vars['option']['option_value']['frequencyCutOff'],
					...
					<p class="formRow-explain">' . 'Bạn có thể chọn để chỉ đếm số truy cập chống lại cơ sở dữ liệu thư rác mà trước đây đã được báo cáo một số lần nhất định.' . '</p>
				'),
		'_type' => 'option',
	),
	array(
