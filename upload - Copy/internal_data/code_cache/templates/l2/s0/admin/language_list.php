<?php
// FROM HASH: f8ae06b679542ac0ce11850da8a14bfb
return array(
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	if ($__vars['language']['language_id']) {
		$__compilerTemp1[] = array(
			...
			'submit' => 'true',
			'tooltip' => 'Bật / Tắt \'' . $__vars['language']['title'] . '\'',
			'_type' => 'toggle',
			'html' => '',
		);
		$__compilerTemp1[] = array(
...
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Ngôn ngữ');
	$__finalCompiled .= '

';
	$__templater->pageParams['pageAction'] = $__templater->preEscaped('
	' . $__templater->button('Thêm ngôn ngữ', array(
