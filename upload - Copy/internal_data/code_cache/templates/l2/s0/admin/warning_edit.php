...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	if ($__templater->method($__vars['warning'], 'isInsert', array())) {
		$__finalCompiled .= '
	';
		$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Thêm cảnh cáo');
		$__finalCompiled .= '
';
	} else {
		$__finalCompiled .= '
	';
		$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Chỉnh sửa cảnh cáo' . $__vars['xf']['language']['label_separator'] . ' ' . $__templater->escape($__vars['warning']['title']));
		$__finalCompiled .= '
';
	}
	$__finalCompiled .= '
...
';
	...
	array(
		...
		'label' => 'Điểm và thời gian hết hạn có thể chỉnh sửa được khi cảnh cáo',
		'_type' => 'option',
	)), array(
	)) . '
		...
		'explain' => 'Một thành viên nhận được cảnh cáo này có thể được thêm vào nhóm thành viên cụ thể cho đến khi cảnh báo hết hạn',
	)) . '
		</div>
