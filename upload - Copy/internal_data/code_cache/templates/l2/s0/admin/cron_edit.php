...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	if ($__templater->method($__vars['entry'], 'isInsert', array())) {
		$__finalCompiled .= '
	';
		$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Thêm mục nhập cron');
		$__finalCompiled .= '
';
	} else {
		$__finalCompiled .= '
	';
		$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Sửa mục Cron' . $__vars['xf']['language']['label_separator'] . ' ' . $__templater->escape($__vars['entry']['title']));
		$__finalCompiled .= '
';
	}
	$__finalCompiled .= '
...
' . $__templater->form('
	...
	<div class="block-container">
		...
		'value' => 'dom',
		'label' => 'Ngày trong tháng' . $__vars['xf']['language']['label_separator'],
	...
	array(
		'value' => 'dow',
		'label' => 'Ngày trong tuần' . $__vars['xf']['language']['label_separator'],
		'_dependent' => array($__templater->formSelect(array(
		'name' => 'run_rules[dow]',
		'readonly' => (!$__templater->method($__vars['entry'], 'canEdit', array())),
	...
	array(
		'value' => '0',
		'label' => '0 ' . $__vars['xf']['language']['parenthesis_open'] . 'Nửa đêm' . $__vars['xf']['language']['parenthesis_close'],
		'_type' => 'option',
	),
	array(
		'value' => '1',
	...
	array(
		...
		'label' => 'Chạy vào giờ',
		'explain' => 'Thời gian chạy được dựa trên múi giờ UTC.',
	)) . '
	...
	array(
		...
		'label' => '
					' . 'Cho phép mục nhập cron tự động chạy khi được lên lịch' . '
				',
		'_type' => 'option',
	)), array(
	)) . '
