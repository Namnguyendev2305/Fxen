...
';
	...
	<div class="block-container">
		...
		'explain' => 'Nếu một người dùng thuộc nhiều nhóm người dùng, CSS tên người dùng và tên người dùng của họ sẽ đến từ nhóm có mức độ ưu tiên kiểu hiển thị cao nhất.',
	)) . '
