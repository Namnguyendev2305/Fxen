<?php
// FROM HASH: 635858e167ffdd874195b025d924c3d6
return array(
...
<tr>
	<td align="center" valign="top" id="bodyTableContainer">
		<table border="0" width="600" cellpadding="0" cellspacing="0" class="container" style="table-layout: fixed;" dir="' . $__templater->escape($__vars['xf']['language']['text_direction']) . '">
		<tr>
...
' . $__templater->filter($__vars['html'], array(array('raw', array()),), true) . '
		...
		<tr>
			<td class="footer" align="center" valign="top">
				<div>' . '<a href="' . $__templater->func('link', array('canonical:index', ), true) . '">Truy cập ' . $__templater->escape($__vars['xf']['options']['boardTitle']) . '</a>' . '</div>
...
' . 'Truy cập ' . $__templater->escape($__vars['xf']['options']['boardTitle']) . ': ' . $__templater->func('link', array('canonical:index', ), true) . '' . '
