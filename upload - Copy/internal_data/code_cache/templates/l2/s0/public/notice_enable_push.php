...
{
	$__finalCompiled = '';
	$__finalCompiled .= '<a href="javascript:" class="notice-dismiss js-enablePushDismiss" aria-label="' . $__templater->filter('Loại bỏ thông báo', array(array('for_attr', array()),), true) . '"></a>
