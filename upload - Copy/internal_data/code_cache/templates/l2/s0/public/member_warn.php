...
';
	...
	$__compilerTemp2[] = array(
		'value' => '0',
		'class' => 'js-FormFiller',
		'label' => 'Cảnh cáo tùy chỉnh' . $__vars['xf']['language']['label_separator'],
	...
	if ($__vars['contentActions']['delete'] OR $__vars['contentActions']['public']) {
		$__compilerTemp3 .= '
			<h2 class="block-formSectionHeader"><span class="block-formSectionHeader-aligner">' . 'Thực hiện với nội dung' . '</span></h2>
	...
	array(
		...
		<h2 class="block-formSectionHeader"><span class="block-formSectionHeader-aligner">' . 'Thông báo thành viên' . '</span></h2>
		<div class="block-body">
			' . $__templater->formCheckBoxRow(array(
	), array(array(
