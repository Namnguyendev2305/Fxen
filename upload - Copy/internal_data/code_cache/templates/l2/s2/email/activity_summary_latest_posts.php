...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	';
		...
		';
			...
			' . ($__vars['post']['User'] ? $__templater->escape($__vars['post']['User']['username']) : $__templater->escape($__vars['post']['username'])) . ' &middot; ' . 'Chủ đề' . $__vars['xf']['language']['label_separator'] . ' <a href="' . $__templater->func('link', array('canonical:threads/post', $__vars['post']['Thread'], array('post_id' => $__vars['post']['post_id'], ), ), true) . '">' . $__templater->escape($__vars['post']['Thread']['title']) . '</a> &middot; ' . $__templater->func('date_time', array($__vars['post']['post_date'], ), true) . '
		');
				$__finalCompiled .= '
		';
				$__vars['footer'] = $__templater->preEscaped('
			' . 'Diễn Đàn' . $__vars['xf']['language']['label_separator'] . ' <a href="' . $__templater->func('link', array('canonical:forums', $__vars['post']['Thread']['Forum'], ), true) . '">' . $__templater->escape($__vars['post']['Thread']['Forum']['title']) . '</a>
		');
				$__finalCompiled .= '
		';
