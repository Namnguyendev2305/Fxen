...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	<a href="' . $__templater->func('link', array('canonical:attachments', array('attachment_id' => $__vars['id'], ), ), true) . '" target="_blank">' . 'Xem đính kèm ' . $__templater->escape($__vars['id']) . '' . '</a>
'), false);
...
'), false);
		...
		$__finalCompiled .= $__templater->func('trim', array('
	<a href="' . $__templater->func('link', array('canonical:attachments', $__vars['attachment'], array('hash' => $__vars['attachment']['temp_hash'], ), ), true) . '" target="_blank">' . 'Xem đính kèm ' . $__templater->escape($__vars['attachment']['filename']) . '' . '</a>
'), false);
	} else {
		$__finalCompiled .= $__templater->func('trim', array('
