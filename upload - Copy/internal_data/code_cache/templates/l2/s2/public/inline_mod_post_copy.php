...
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Kiểm duyệt trực tuyến - Sao chép bài viết');
	$__finalCompiled .= '
...
';
	...
	<div class="block-container">
		<div class="block-body js-prefixListenContainer">
			' . $__templater->formInfoRow('Bạn có chắc chắn muốn sao chép ' . $__templater->escape($__vars['total']) . ' bài viết đến một chủ đề mới?', array(
		'rowtype' => 'confirm',
	)) . '
