<?php
// FROM HASH: d14454b28a2af795ca03242aff425261
return array(
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Xem lại tin nhắn đã chọn');
	$__finalCompiled .= '

	<div class="block">
		<div class="block-container">
			<div class="block-row block-row--minor">
				' . 'Kéo biểu tượng để sắp xếp lại các tin nhắn.' . '
			</div>
...
'arguments' => function($__templater, array $__vars) { return array(
		...
		'messageSelector' => '!',
		'storageKey' => '!',
		'addMessage' => 'Bài viết đã được thêm vào trích dẫn.',
		'removeMessage' => 'Bài viết được xóa khỏi nhiều trích dẫn',
		'row' => false,
	); },
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	$__vars['button'] = $__templater->preEscaped('
		' . $__templater->button('
			' . 'Chèn các trích dẫn' . $__vars['xf']['language']['ellipsis'] . '
		', array(
