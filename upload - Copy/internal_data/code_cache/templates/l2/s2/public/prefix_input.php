<?php
// FROM HASH: 287c70d4d83a9f3262f698dd793f83d5
return array(
'macros' => array('template' => array(
	...
	<script type="text/template">
		...
		<div class="menu-row">
			<a class="menuPrefix menuPrefix--none"
				data-prefix-id="0"
				data-prefix-class=""
				role="option">' . $__vars['xf']['language']['parenthesis_open'] . 'Không tiền tố' . $__vars['xf']['language']['parenthesis_close'] . '</a>
		</div>
	</script>
';
	...
	<div class="js-prefixContainer">
		<div class="inputGroup inputGroup--joined u-jsOnly">
			<div class="inputGroup-text">
				<div class="' . $__templater->escape($__vars['prefixClass']) . '" data-xf-init="prefix-menu"
					' . ($__vars['href'] ? ((((' data-href="' . $__templater->escape($__vars['href'])) . '" data-listen-to="') . $__templater->escape($__vars['listenTo'])) . '"') : '') . '
					' . ($__vars['helpHref'] ? ((' data-help-href="' . $__templater->escape($__vars['helpHref'])) . '"') : '') . '
					' . ($__vars['helpSkipInitial'] ? ' data-help-skip-initial="yes"' : '') . '
				>
					<a class="menuTrigger menuTrigger--prefix" data-xf-click="menu" role="button" tabindex="0" aria-expanded="false" aria-haspopup="true">
						<span class="js-activePrefix">' . $__vars['xf']['language']['parenthesis_open'] . 'Không tiền tố' . $__vars['xf']['language']['parenthesis_close'] . '</span>
					</a>
