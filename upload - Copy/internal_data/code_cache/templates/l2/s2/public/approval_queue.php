...
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Đang chờ phê duyệt');
	$__finalCompiled .= '
	...
	if ($__vars['filters']['content_type']) {
		$__compilerTemp1 .= '
								<li><a href="' . $__templater->func('link', array('approval-queue', null, $__templater->filter($__vars['filters'], array(array('replace', array(array('content_type' => null, ), )),), false), ), true) . '"
									...
									<span class="filterBar-filterToggle-label">' . 'Loại nội dung' . $__vars['xf']['language']['label_separator'] . '</span>
...
';
		...
		$__finalCompiled .= '
	<div class="blockMessage">' . 'Không có nội dung nào đang chờ phê duyệt.' . '</div>
';
	}
