...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	', 'replace');
		$__finalCompiled .= '
	';
		$__templater->setPageParam('sideNavTitle', 'Trang trợ giúp');
		$__finalCompiled .= '
';
	}
	$__finalCompiled .= '
...
';
	$__templater->modifySideNavHtml('_xfWidgetPositionSideNav4b4b46f71c821a3f90681adf1f4ba979', $__templater->widgetPosition('help_page_sidenav', array()), 'replace');
	$__finalCompiled .= '
