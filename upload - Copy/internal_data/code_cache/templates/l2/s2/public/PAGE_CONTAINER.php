<?php
// FROM HASH: 81033286aec59276093866f68d6051f0
return array(
...
';
	...
	if ($__vars['xf']['visitor']['is_moderator'] AND ((!$__vars['xf']['options']['reportIntoForumId']) AND $__vars['xf']['session']['reportCounts']['total'])) {
		$__compilerTemp1 .= '
					<a href="' . $__templater->func('link', array('reports', ), true) . '"
						...
						title="' . ($__vars['xf']['session']['reportCounts']['lastBuilt'] ? (($__templater->filter('Cập nhật báo cáo lần cuối' . $__vars['xf']['language']['label_separator'], array(array('for_attr', array()),), true) . ' ') . $__templater->func('date_time', array($__vars['xf']['session']['reportCounts']['lastBuilt'], ), true)) : '') . '">
						' . 'Báo cáo' . '
					</a>
				';
	}
	...
	if ($__vars['xf']['visitor']['is_moderator']) {
		$__compilerTemp2 .= '
								<a href="' . $__templater->func('link', array('approval-queue', ), true) . '" class="menu-linkRow">' . 'Đang chờ phê duyệt' . '</a>
							';
	}
	$__compilerTemp2 .= '
							';
	if ($__vars['xf']['visitor']['is_moderator'] AND (!$__vars['xf']['options']['reportIntoForumId'])) {
		$__compilerTemp2 .= '
								<a href="' . $__templater->func('link', array('reports', ), true) . '" class="menu-linkRow" title="' . ($__vars['xf']['session']['reportCounts']['lastBuilt'] ? (($__templater->filter('Cập nhật báo cáo lần cuối' . $__vars['xf']['language']['label_separator'], array(array('for_attr', array()),), true) . ' ') . $__templater->func('date_time', array($__vars['xf']['session']['reportCounts']['lastBuilt'], ), true)) : '') . '">' . 'Báo cáo' . '</a>
							';
	}
	$__compilerTemp2 .= '
							' . '
	...
	if (strlen(trim($__compilerTemp2)) > 0) {
		$__compilerTemp1 .= '
					<a class="p-staffBar-link menuTrigger" data-xf-click="menu" data-xf-key="alt+m" role="button" tabindex="0" aria-expanded="false" aria-haspopup="true">' . 'Quản trị' . '</a>
					<div class="menu" data-menu="menu" aria-hidden="true">
						<div class="menu-content">
							<h4 class="menu-header">' . 'Công cụ quản trị' . '</h4>
							' . $__compilerTemp2 . '
						</div>
					</div>
				';
			...
			$__compilerTemp4 .= '
				...
				'title' => '',
							...
							<a href="' . $__templater->func('link', array('logout', null, array('t' => $__templater->func('csrf_token', array(), false), ), ), true) . '" class="p-navgroup-link">
								<span class="p-navgroup-linkText">' . 'Thoát' . '</span>
							</a>
						';
		} else {
			$__compilerTemp4 .= '
				...
				'title' => '',
							...
							<div class="menu menu--structural menu--wide menu--account" data-menu="menu" aria-hidden="true"
								...
								<div class="menu-content js-visitorMenuBody">
									<div class="menu-row">
										' . 'Đang tải' . $__vars['xf']['language']['ellipsis'] . '
									</div>
								</div>
							</div>
							...
							<a href="' . $__templater->func('link', array('conversations', ), true) . '"
								...
								data-menu-pos-ref="< .p-navgroup"
								title="' . $__templater->filter('Trò chuyện', array(array('for_attr', array()),), true) . '"
								aria-label="' . $__templater->filter('Trò chuyện', array(array('for_attr', array()),), true) . '"
								aria-expanded="false"
								aria-haspopup="true">
									...
									<div class="menu-footer menu-footer--split">
										<div class="menu-footer-main">
											<ul class="listInline listInline--bullet">
												<li><a href="' . $__templater->func('link', array('conversations', ), true) . '">' . 'Hiển thị tất cả' . '</a></li>
												';
			if ($__templater->method($__vars['xf']['visitor'], 'canStartConversation', array())) {
				$__compilerTemp4 .= '
													<li><a href="' . $__templater->func('link', array('conversations/add', ), true) . '">' . 'Bắt đầu trò chuyện mới' . '</a></li>
												';
			}
			$__compilerTemp4 .= '
											</ul>
							...
							<a href="' . $__templater->func('link', array('account/alerts', ), true) . '"
								...
								data-xf-key="' . $__templater->filter('.', array(array('for_attr', array()),), true) . '"
								data-menu-pos-ref="< .p-navgroup"
								title="' . $__templater->filter('Thông báo', array(array('for_attr', array()),), true) . '"
								aria-label="' . $__templater->filter('Thông báo', array(array('for_attr', array()),), true) . '"
								aria-expanded="false"
								aria-haspopup="true">
								<i aria-hidden="true"></i>
								<span class="p-navgroup-linkText">' . '' . '</span>
							...
							<div class="menu menu--structural menu--medium" data-menu="menu" aria-hidden="true"
								...
								<div class="menu-content">
									...
									<div class="menu-footer menu-footer--split">
										<div class="menu-footer-main">
											<ul class="listInline listInline--bullet">
												<li><a href="' . $__templater->func('link', array('account/alerts', ), true) . '">' . 'Hiển thị tất cả' . '</a></li>
												<li><a href="' . $__templater->func('link', array('account/alerts/mark-read', ), true) . '" class="js-alertsMarkRead">' . 'Đánh dấu đã đọc' . '</a></li>
												<li><a href="' . $__templater->func('link', array('account/preferences', ), true) . '">' . 'Tùy chọn' . '</a></li>
											</ul>
										</div>
									</div>
								</div>
	...
	if ($__templater->method($__vars['xf']['visitor'], 'canSearch', array())) {
		$__compilerTemp5 .= '
						<a href="' . $__templater->func('link', array('search', ), true) . '"
							...
							data-xf-click="menu"
							data-xf-key="' . $__templater->filter('/', array(array('for_attr', array()),), true) . '"
							aria-label="' . $__templater->filter('Tìm kiếm', array(array('for_attr', array()),), true) . '"
							aria-expanded="false"
							aria-haspopup="true"
							title="' . $__templater->filter('Tìm kiếm', array(array('for_attr', array()),), true) . '">
							<i aria-hidden="true"></i>
		...
		if ($__vars['searchConstraints']) {
			$__compilerTemp5 .= '
				...
				'name' => 'keywords',
				'placeholder' => 'Tìm kiếm' . $__vars['xf']['language']['ellipsis'],
				'aria-label' => 'Tìm kiếm',
		...
		if ($__vars['xf']['options']['enableTagging']) {
			$__compilerTemp7 .= '
													<span tabindex="0" role="button"
														data-xf-init="tooltip" data-trigger="hover focus click" title="' . $__templater->filter('Tags will also be searched in content where tags are supported', array(array('for_attr', array()),), true) . '">
		...
		$__compilerTemp5 .= $__templater->formCheckBox(array(
			...
			'_type' => 'option',
								...
								<div class="menu-row">
									<div class="inputGroup">
										<span class="inputGroup-text" id="ctrl_search_menu_by_member">' . 'Bởi' . $__vars['xf']['language']['label_separator'] . '</span>
			...
			'icon' => 'search',
										...
										' . $__templater->button('Tìm kiếm nâng cao' . $__vars['xf']['language']['ellipsis'], array(
	...
	<nav class="p-nav">
		<div class="p-nav-inner">
			' . $__templater->button('
				<i aria-hidden="true"></i>
			', array(
		'class' => 'button--plain p-nav-menuTrigger',
		'data-xf-click' => 'off-canvas',
		'data-menu' => '.js-headerOffCanvasMenu',
		'tabindex' => '0',
		'aria-label' => $__templater->filter('Menu', array(array('for_attr', array()),), false),
	), '', array(
	)) . '
			...
			<div class="p-nav-opposite">
				...
				<div class="p-navgroup p-discovery' . ((!$__templater->method($__vars['xf']['visitor'], 'canSearch', array())) ? ' p-discovery--noSearch' : '') . '">
					<a href="' . $__templater->func('link', array('whats-new', ), true) . '"
						...
						aria-label="' . $__templater->filter('Tin tức mới', array(array('for_attr', array()),), true) . '"
						title="' . $__templater->filter('Tin tức mới', array(array('for_attr', array()),), true) . '">
						<i aria-hidden="true"></i>
...
<div class="offCanvasMenu offCanvasMenu--nav js-headerOffCanvasMenu" data-menu="menu" aria-hidden="true" data-ocm-builder="navigation">
	...
	<div class="offCanvasMenu-content">
		<div class="offCanvasMenu-header">
			' . 'Menu' . '
			<a class="offCanvasMenu-closer" data-menu-close="true" role="button" tabindex="0" aria-label="' . $__templater->filter('Đóng', array(array('for_attr', array()),), true) . '"></a>
		</div>
		';
	if ($__vars['xf']['visitor']['user_id']) {
		$__finalCompiled .= '
	...
	$__finalCompiled .= '
		...
		<div class="offCanvasMenu-installBanner js-installPromptContainer" style="display: none;" data-xf-init="install-prompt">
			...
			' . $__templater->button('Cài đặt', array(
				...
				<div class="block-body">
					<div class="block-row">
						...
						<p style="text-align: center">
							<img src="' . $__templater->func('base_url', array('styles/default/xenforo/add_to_home.gif', ), true) . '" width="222" height="480" />
						</p>
						<p>
							<small><strong>' . 'Chú ý' . $__vars['xf']['language']['label_separator'] . '</strong> ' . 'This feature currently requires accessing the site using the built-in Safari browser.' . '</small>
						</p>
					</div>
				</div>
			</template>
...
<footer class="p-footer" id="footer">
	...
	if ($__templater->method($__vars['xf']['cookieConsent'], 'getMode', array()) == 'advanced') {
		$__compilerTemp12 .= '
							<li><a href="' . $__templater->func('link', array('misc/cookies', ), true) . '" rel="nofollow"
	...
	if ($__templater->method($__vars['xf']['visitor'], 'canChangeStyle', array())) {
		$__compilerTemp12 .= '
							<li><a href="' . $__templater->func('link', array('misc/style', ), true) . '" data-xf-click="overlay"
								data-xf-init="tooltip" title="' . $__templater->filter('Chọn giao diện', array(array('for_attr', array()),), true) . '" rel="nofollow">
	...
	if ($__templater->method($__vars['xf']['visitor'], 'canChangeLanguage', array())) {
		$__compilerTemp12 .= '
							<li><a href="' . $__templater->func('link', array('misc/language', ), true) . '" data-xf-click="overlay"
								data-xf-init="tooltip" title="' . $__templater->filter('Chọn ngôn ngữ', array(array('for_attr', array()),), true) . '" rel="nofollow">
	...
	if ($__templater->method($__vars['xf']['visitor'], 'canUseContactForm', array())) {
		...
		if ($__vars['xf']['contactUrl']) {
			$__finalCompiled .= '
							<li><a href="' . $__templater->escape($__vars['xf']['contactUrl']) . '" data-xf-click="' . ((($__vars['xf']['options']['contactUrl']['overlay'] OR ($__vars['xf']['options']['contactUrl']['type'] == 'default'))) ? 'overlay' : '') . '">' . 'Liên hệ' . '</a></li>
						';
		}
		$__finalCompiled .= '
					';
	...
	if ($__vars['xf']['tosUrl']) {
		$__finalCompiled .= '
						<li><a href="' . $__templater->escape($__vars['xf']['tosUrl']) . '">' . 'Quy định và Nội quy' . '</a></li>
					';
	}
	$__finalCompiled .= '
	...
	if ($__vars['xf']['privacyPolicyUrl']) {
		$__finalCompiled .= '
						<li><a href="' . $__templater->escape($__vars['xf']['privacyPolicyUrl']) . '">' . 'Chính sách bảo mật' . '</a></li>
					';
	}
	$__finalCompiled .= '
	...
	if ($__vars['xf']['helpPageCount']) {
		$__finalCompiled .= '
						<li><a href="' . $__templater->func('link', array('help', ), true) . '">' . 'Trợ giúp' . '</a></li>
					';
	}
	$__finalCompiled .= '
	...
	if ($__vars['xf']['homePageUrl']) {
		$__finalCompiled .= '
						<li><a href="' . $__templater->escape($__vars['xf']['homePageUrl']) . '">' . 'Trang chủ' . '</a></li>
					';
	}
	$__finalCompiled .= '
...
<div class="u-navButtons js-navButtons" data-trigger-type="' . $__templater->func('property', array('scrollJumpButtons', ), true) . '">
	' . $__templater->button($__templater->fontAwesome('fa-arrow-left', array(
...
';
	...
	<div class="u-scrollButtons js-scrollButtons" data-trigger-type="' . $__templater->func('property', array('scrollJumpButtons', ), true) . '">
		...
		if ($__templater->func('property', array('scrollJumpButtons', ), false) != 'up') {
			...
			)) . '<span class="u-srOnly">' . 'Dưới' . '</span>', array(
				'href' => '#footer',
				'class' => 'button--scroll',
				'data-xf-click' => 'scroll-to',
			), '', array(
