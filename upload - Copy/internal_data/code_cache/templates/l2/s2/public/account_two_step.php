...
';
	...
	<div class="blockMessage blockMessage--important blockMessage--iconic">
		...
		<a href="' . $__templater->func('link', array('account/two-step/manage', array('provider_id' => 'backup', ), ), true) . '">' . 'Xem mã dự phòng của bạn.' . '</a>
...
';
	...
	<div class="block">
		...
		if ($__vars['currentTrustRecord']) {
			$__finalCompiled .= '
					<div class="block-row block-row--separated">
						' . 'Thiết bị này hiện đáng tin cậy cho đến ' . $__templater->func('date', array($__vars['currentTrustRecord']['trusted_until'], ), true) . '. Bạn sẽ không cần phải hoàn thành xác minh hai bước từ thiết bị này cho đến khi đó. Bạn có thể chọn để ngừng tin tưởng thiết bị này để bạn sẽ được nhắc nhở để hoàn thành xác minh hai bước khi bạn tiếp theo đăng nhập.' . '
