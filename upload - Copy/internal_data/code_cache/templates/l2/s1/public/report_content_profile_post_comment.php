	...
	';
		...
		<div class="block-row block-row--separated block-row--minor">
			<dl class="pairs pairs--inline">
				<dt>' . 'Bài viết trên hồ sơ' . '</dt>
				<dd><a href="' . $__templater->func('link', array('profile-posts', $__vars['report']['content_info'], ), true) . '">' . 'Bài viết trên hồ sơ của ' . $__templater->escape($__vars['report']['content_info']['profileUser']['username']) . '' . '</a></dd>
			</dl>
		</div>
	';
		}
...
';
	...
	<div class="block-row block-row--separated block-row--minor">
		<dl class="pairs pairs--inline">
			<dt>' . 'Bài viết trên hồ sơ' . '</dt>
			<dd><a href="' . $__templater->func('link', array('profile-posts', $__vars['report']['content_info'], ), true) . '">' . 'Bài viết trên hồ sơ của ' . $__templater->escape($__vars['report']['content_info']['profile_username']) . '' . '</a></dd>
		</dl>
	</div>
';
	}
