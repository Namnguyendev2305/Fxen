<?php
// FROM HASH: 78f4af10a4f44c6c3509e64f03e8d3c7
return array(
...
';
	...
	if ($__vars['xf']['options']['enableNotices'] AND (($__templater->func('count', array($__vars['xf']['session']['dismissedNotices'], ), false) > 0))) {
		$__compilerTemp6 .= '
			...
			'hint' => 'Bất kỳ lưu ý nào bạn đã bỏ qua trước đây sẽ được khôi phục để xem nếu bạn đánh dấu vào mục này.',
			'_type' => 'option',
		)), array(
		)) . '
			';
	...
	if (!$__templater->test($__vars['alertOptOuts'], 'empty', array())) {
		...
		$__compilerTemp8 .= '
			<h2 class="block-formSectionHeader"><span class="block-formSectionHeader-aligner">' . 'Nhận thông báo khi ai đó' . $__vars['xf']['language']['ellipsis'] . '</span></h2>
