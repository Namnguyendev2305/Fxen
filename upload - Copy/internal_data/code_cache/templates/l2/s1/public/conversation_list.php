...
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Trò chuyện');
...
';
	...
	' . $__templater->button('Tạo cuộc trò chuyện', array(
...
<div class="block" data-xf-init="inline-mod" data-type="conversation" data-href="' . $__templater->func('link', array('inline-mod', ), true) . '">
	...
	$__finalCompiled .= '
		...
		'label' => 'Hiển thị tất cả đối thoại',
		'_type' => 'option',
	),
	array(
		'value' => 'started',
		...
		'data-hide' => 'true',
		'label' => 'Bắt đầu bởi' . $__vars['xf']['language']['ellipsis'],
	...
	array(
		...
		'data-hide' => 'true',
		'label' => 'Được nhận bởi' . $__vars['xf']['language']['ellipsis'],
		'_dependent' => array($__templater->formTextBox(array(
		'name' => 'receiver',
		...
		'label' => 'Cuộc trò chuyện đã gắn sao',
		'_type' => 'option',
	),
	array(
		'name' => 'unread',
		'selected' => $__vars['filters']['unread'],
		'label' => 'Cuộc trò chuyện chưa đọc',
		'_type' => 'option',
	))) . '
							</div>
	...
	if (!$__templater->test($__vars['userConvs'], 'empty', array())) {
		...
		$__finalCompiled .= '
				<div class="block-row">' . 'Không có cuộc trò chuyện nào hiển thị.' . '</div>
			';
	}
	$__finalCompiled .= '
		</div>
