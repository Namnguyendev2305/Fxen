...
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Quy định và Nội quy');
	$__finalCompiled .= '

<div class="blockMessage blockMessage--iconic blockMessage--important">
	' . 'Please read and accept our terms and rules before continuing.' . ' ' . 'Cập nhật mới nhất' . $__vars['xf']['language']['label_separator'] . ' ' . $__templater->func('date_dynamic', array($__vars['xf']['options']['termsLastUpdate'], array(
	))) . '.
</div>
