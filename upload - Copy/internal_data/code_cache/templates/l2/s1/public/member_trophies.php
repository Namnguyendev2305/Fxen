...
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Điểm thưởng dành cho ' . $__templater->escape($__vars['user']['username']) . '');
	$__finalCompiled .= '
...
<div class="block">
	...
	if (!$__templater->test($__vars['trophies'], 'empty', array())) {
		...
		$__finalCompiled .= '
			<div class="block-body block-row">' . '' . $__templater->escape($__vars['user']['username']) . ' chưa được trao bất kỳ danh hiệu nào.' . '</div>
		';
	}
	$__finalCompiled .= '
		<div class="block-footer block-footer--split">
			<span class="block-footer-counter">' . 'Tổng điểm' . $__vars['xf']['language']['label_separator'] . ' ' . $__templater->func('number', array($__vars['user']['trophy_points'], ), true) . '</span>
