...
';
	$__templater->breadcrumb($__templater->preEscaped('Từ khóa'), $__templater->func('link', array('tags', ), false), array(
	));
	$__finalCompiled .= '
	...
	if ($__vars['modTypes']) {
		...
		if ($__vars['activeModType']) {
			$__finalCompiled .= '
									...
									<a href="' . $__templater->func('link', array('tags', $__vars['tag'], array('page' => $__vars['page'], ), ), true) . '" class="menu-linkRow">' . 'Vô hiệu hóa' . '</a>
								';
		}
		$__finalCompiled .= '
							</div>
