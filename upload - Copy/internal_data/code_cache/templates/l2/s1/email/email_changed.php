...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	' . '' . $__templater->escape($__vars['xf']['options']['boardTitle']) . ' - Email đã thay đổi' . '
</mail:subject>

' . '' . $__templater->escape($__vars['user']['username']) . ',<br />
<br />
Email của bạn tại ' . (((('<a href="' . $__templater->func('link', array('canonical:index', ), true)) . '">') . $__templater->escape($__vars['xf']['options']['boardTitle'])) . '</a>') . ' gần đây đã được thay đổi thành ' . $__templater->escape($__vars['newEmail']) . '. Nếu bạn thực hiện thay đổi này, bạn có thể bỏ qua thông báo này.br />
<br />
