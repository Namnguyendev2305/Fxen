...
return array (
  ...
  'option_group_description.appearance' => 'Các tùy chọn này kiểm soát cách trang web của bạn xuất hiện với khách truy cập của bạn.',
  ...
  'option_group_description.boardActive' => 'Bật hoặc tắt diễn đàn của bạn ở đây.',
...
You may set a user into \'discouraged\' mode by editing their user profile, or discourage an IP address or IP address range.',
  ...
  'option_group_description.newsfeed' => 'The news feed, or activity stream is a constantly-updated log of things that your registered members do, which can be viewed back by other visitors. It is possible to filter the news feed down to just users you follow, or a single user.',
  ...
  'option_group_description.sharing' => 'Các tùy chọn này kiểm soát các tính năng chia sẻ mạng xã hội của XenForo.',
